...
import org.jbpm.bpel.tutorial.account.types.TAccountOperation;

/**
 * @author Alejandro Guizar
 * @version $Revision: 1.2 $ $Date: 2006/08/21 01:05:59 $
 */
public class AccountSystem_Impl implements AccountSystem, Remote {
  ...
  public double updateBalance(TAccountOperation body) throws RemoteException {

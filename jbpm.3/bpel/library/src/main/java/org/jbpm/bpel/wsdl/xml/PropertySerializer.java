...
/**
 * Translates between <code>&lt;property/&gt;</code> XML elements and
 * {@link Property} instances.
 * @author Alejandro Guízar
 * @version $Revision: 1.2 $ $Date: 2006/08/21 01:05:59 $
 */
public class PropertySerializer implements ExtensionSerializer,
  ...
  public ExtensibilityElement unmarshall(Class parentType, QName elementType,
    ...
    Property property = (Property) extReg.createExtension(parentType,
        elementType);
    ...
    // type attribute
    String type = elem.getAttribute(WsdlConstants.ATTR_TYPE);
    property.setType(XmlUtil.getQName(type, elem));
  ...
  public void marshall(Class parentType, QName elementType,
    ...
    // name attribute
    DOMUtils.printAttribute(WsdlConstants.ATTR_NAME, property.getQName()
        .getLocalPart(), pw);

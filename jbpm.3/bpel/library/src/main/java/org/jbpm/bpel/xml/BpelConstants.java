...
public class BpelConstants {
  ...
  // namespaces
  public static final String NS_BPWS = "http://schemas.xmlsoap.org/ws/2004/03/business-process/";
  public static final String NS_BPWS_1_1 = "http://schemas.xmlsoap.org/ws/2003/03/business-process/";
  ...
  public static final String NS_VENDOR = "http://jbpm.org/bpel";
  ...
  public static final String ATTR_INSTANCE_COMPENSATION = "enableInstanceCompensation";
  ...
  // standard faults
  public static final QName FAULT_SELECTION_FAILURE = new QName(NS_BPWS,
      "selectionFailure");
  public static final QName FAULT_CONFLICTING_REQUEST = new QName(NS_BPWS,
      "conflictingRequest");
  public static final QName FAULT_MISSING_REQUEST = new QName(NS_BPWS,
      "missingRequest");
  public static final QName FAULT_MISMATCHED_ASSIGNMENT = new QName(NS_BPWS,
      "mismatchedAssignmentFailure");
  public static final QName FAULT_JOIN_FAILURE = new QName(NS_BPWS,
      "joinFailure");
  public static final QName FAULT_CORRELATION_VIOLATION = new QName(NS_BPWS,
      "correlationViolation");
  public static final QName FAULT_UNINITIALIZED_VARIABLE = new QName(NS_BPWS,
      "uninitializedVariable");
  public static final QName FAULT_UNSUPPORTED_REFERENCE = new QName(NS_BPWS,
      "unsupportedReference");
  public static final QName FAULT_UNINITIALIZED_PARTNER_ROLE = new QName(
      NS_BPWS, "uninitializedPartnerRole");
  public static final QName FAULT_SUB_LANGUAGE_EXECUTION = new QName(
      BpelConstants.NS_BPWS, "subLanguageExecutionFault");

  // application descriptor
  public static final String ATTR_VERSION = "version";
  public static final String ATTR_BIND_SUBCONTEXT = "bindSubcontext";
  ...
  public static final String ATTR_BIND_NAME = "bindName";
  ...
  public static String[] BPEL_2_ACTIVITIES = { ELEM_EMPTY, ELEM_RECEIVE,
      ELEM_REPLY, ELEM_INVOKE, ELEM_ASSIGN, ELEM_THROW, ELEM_EXIT, ELEM_WAIT,
      ELEM_SEQUENCE, ELEM_IF, "switch", ELEM_WHILE, ELEM_PICK, ELEM_FLOW,
      ELEM_SCOPE, ELEM_COMPENSATE, ELEM_RETHROW, ELEM_VALIDATE };

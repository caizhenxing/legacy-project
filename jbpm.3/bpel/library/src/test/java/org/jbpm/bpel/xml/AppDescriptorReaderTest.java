...
public class AppDescriptorReaderTest extends TestCase {
  ...
  public void testMyRolePortInfo() throws Exception {
    String text = "<myRole bindName='port/a'/>";
    AppMyRole myRole = reader.readMyRole(XmlUtil.parseElement(text));
    
    assertEquals("port/a", myRole.getBindName());
  }
  ...
  public void testPartnerRoleInitiate() throws Exception {
    ...
    assertEquals(AppPartnerRole.Initiate.PULL, partnerRole.getInitiate());
  }

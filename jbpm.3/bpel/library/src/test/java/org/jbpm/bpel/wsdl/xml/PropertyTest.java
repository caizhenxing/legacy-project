...
public class PropertyTest extends TestCase {
  ...
  public void testGetProperty() {
    ...
    Property property = WsdlUtil.getProperty(definition, new QName(tns, "customerID"));
    assertNotNull(property);
    assertEquals(new QName(BpelConstants.NS_XML_SCHEMA, "string"), property.getType());

    property = WsdlUtil.getProperty(definition, new QName(tns, "invoiceNumber"));
    assertNotNull(property);
    assertEquals(new QName(BpelConstants.NS_XML_SCHEMA, "int"), property.getType());
  }

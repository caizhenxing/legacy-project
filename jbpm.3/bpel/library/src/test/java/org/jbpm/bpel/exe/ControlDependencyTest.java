...
public class ControlDependencyTest extends AbstractExeTestCase {
  ...
  public void testControlDependencyScenario() throws Exception {
    ...
    /*The switch gets executed and the A2 path is taken. A negative status is set to A3*/
    ...
    /*A4 is not yet able to receive due to its indirect control dependency to A1*/

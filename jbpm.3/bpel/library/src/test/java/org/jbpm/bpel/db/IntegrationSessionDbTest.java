...
public class IntegrationSessionDbTest extends AbstractDbTestCase {
  ...
  public void setUp() throws Exception {
    ...
    String processResource = getClass().getResource("integrationSession.bpel").toString();
    BpelReader.getInstance().read(processDefinition, new InputSource(processResource));

...
public class ScopeDefTest extends TestCase {
  ...
  public void setUp() {  
    ...
    elementVariable.setType(new ElementType(elementName));
    ...
    message.setQName(new QName(BpelConstants.NS_EXAMPLES, "aMessage"));
    message.addPart(part);
    
    VariableDefinition messageVariable = new VariableDefinition();
    messageVariable.setName("aMessageVariable");
    messageVariable.setType(new MessageType(message));

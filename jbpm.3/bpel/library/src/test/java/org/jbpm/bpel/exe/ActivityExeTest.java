...
public class ActivityExeTest extends TestCase {
  ...
  LinkDefinition positiveLink;
  LinkDefinition negativeLink;
  LinkDefinition defaultLink;
  ...
  public void setUp() {
    ProcessDefinition pd = new BpelDefinition("testDef");
  ...
  public void testLinkResolvedPositive() throws Exception {
    ...
    targetLink.determineStatus(new ExecutionContext(secondChild));
    assertCompleted();
  }
  ...
  public static class TestTransition extends Transition {

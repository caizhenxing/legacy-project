 ...
 */
public class ElementValueDbTest extends XmlValueDbTest {
  ...
  protected void update(Element variableValue) {
    ...
    Element childElem = variableValue.getOwnerDocument().createElementNS(BpelConstants.NS_EXAMPLES, CHILD_LOCALNAME);

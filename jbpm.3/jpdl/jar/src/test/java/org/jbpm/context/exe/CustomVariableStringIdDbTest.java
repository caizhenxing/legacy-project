...
public class CustomVariableStringIdDbTest extends AbstractDbTestCase {
  ...
  static JbpmConfiguration customStringJbpmConfiguration = null;
  
  static {
    customStringJbpmConfiguration = JbpmConfiguration.parseResource("org/jbpm/jbpm.test.cfg.xml");
    DbPersistenceServiceFactory dbPersistenceServiceFactory = (DbPersistenceServiceFactory) customStringJbpmConfiguration.getServiceFactory(Services.SERVICENAME_PERSISTENCE);

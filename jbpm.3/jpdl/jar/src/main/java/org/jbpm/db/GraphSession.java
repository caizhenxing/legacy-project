...
public class GraphSession {
  ...
  public static class AverageNodeTimeEntry {
    ...
    public AverageNodeTimeEntry(final long nodeId, final String nodeName, final int count, final float averageDuration, final long minDuration, final long maxDuration) {
      this.nodeId = nodeId;

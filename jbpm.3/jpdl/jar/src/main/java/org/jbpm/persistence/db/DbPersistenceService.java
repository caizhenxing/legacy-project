...
public class DbPersistenceService implements Service, PersistenceService {
  ...
  public void close() {
    if ( (session!=null)
      ...
      throw new JbpmException("setRollbackOnly was invoked while configurations specifies user managed transactions");
    }
    endTransaction();
    closeSession();
  }
  ...
  public void setRollbackOnly(boolean isRollbackOnly) {
    throw new UnsupportedOperationException("method setRollbackOnly has been removed");
  }
  /**
   * @deprecated use {@link org.jbpm.tx.TxService} instead.
   */

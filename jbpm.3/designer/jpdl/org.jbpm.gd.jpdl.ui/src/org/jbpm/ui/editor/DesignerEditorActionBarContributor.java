...
public class DesignerEditorActionBarContributor extends
    ...
    private static final String[] TEXTEDITOR_ACTION_IDS = {
 	...
 	public void setActivePage(IEditorPart activeEditor) {
		...
		if (activeEditor instanceof DesignerGraphicalEditorPage) {
			hookGlobalGraphicalEditorActions((DesignerGraphicalEditorPage)activeEditor, actionBars);
	...
	private void hookGlobalGraphicalEditorActions(
			DesignerGraphicalEditorPage part, IActionBars actionBars) {

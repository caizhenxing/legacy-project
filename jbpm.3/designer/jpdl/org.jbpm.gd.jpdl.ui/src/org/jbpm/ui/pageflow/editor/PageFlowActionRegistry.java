...
public class PageFlowActionRegistry extends ActionRegistry {
	...
	public PageFlowActionRegistry(IEditorPart editorPart) {
	...
	private void addEditPartAction(SelectionAction action) {

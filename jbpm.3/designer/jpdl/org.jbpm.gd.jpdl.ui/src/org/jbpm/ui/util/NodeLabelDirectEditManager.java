...
public class NodeLabelDirectEditManager extends DirectEditManager {
	...
	public NodeLabelDirectEditManager(GraphicalEditPart source, Class editorType, CellEditorLocator locator) {
		super(source, editorType, locator);
	}

	protected void initCellEditor() {
		Text text = (Text) getCellEditor().getControl();
		String name = ((NodeGraphicalEditPart)getEditPart()).getNode().getName();

...
public class NodeHeaderFigure extends Figure {
	...
	public NodeHeaderFigure(String nodeName, String nodeType, String iconName, boolean hideName) {
		...
		addEmbeddedParent(nodeName, nodeType, getStdIconDescriptor(iconName), hideName);
	}
  ...
  private ImageDescriptor getStdIconDescriptor(String nodeType) {
    return ImageDescriptor.createFromFile(SharedImages.class, "icon/" + nodeType.toLowerCase() + ".gif");
  }
  ...
  private Image getNodeIcon(ImageDescriptor iconDescriptor) {
	...
	protected void paintClientArea(Graphics graphics) {
		...
		graphics.setForegroundColor(PluginConstants.veryLightGray);

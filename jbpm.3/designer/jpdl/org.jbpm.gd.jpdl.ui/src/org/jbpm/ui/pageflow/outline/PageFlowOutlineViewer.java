 ...
 */
package org.jbpm.ui.pageflow.outline;
...
import org.jbpm.ui.pageflow.editor.PageFlowEditor;
import org.jbpm.ui.pageflow.editor.PageFlowModelViewer;
import org.jbpm.ui.part.tree.OutlineRootTreeEditPart;

public class PageFlowOutlineViewer extends ContentOutlinePage {
	...
	public PageFlowOutlineViewer(PageFlowEditor editor) {
	...
	private PageFlowModelViewer getModelViewer() {
	...
	private void createTreeview(Composite parent) {
		...
		getViewer().setEditPartFactory(new EditPartFactory() {
			public EditPart createEditPart(EditPart context, Object model) {
				if (model instanceof PageFlowOutlineContent) {
		...
		setContents(new PageFlowOutlineContent(editor.getProcessDefinition()));
	}

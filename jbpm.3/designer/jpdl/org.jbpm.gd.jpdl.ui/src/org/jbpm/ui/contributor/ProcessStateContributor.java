...
import org.jbpm.ui.model.ProcessState;
import org.jbpm.ui.part.graph.NodeGraphicalEditPart;
import org.jbpm.ui.part.tree.NodeTreeEditPart;

public class ProcessStateContributor implements ElementContributor {
	...
	public EditPart createGraphicalEditPart(Element element) {
		return new NodeGraphicalEditPart((Node)element);
	}
	...
	public IFigure createFigure() {
		return new NodeFigure("Process State");
	}
}

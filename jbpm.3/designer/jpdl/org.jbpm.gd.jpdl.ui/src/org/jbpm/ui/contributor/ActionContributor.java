...
import org.jbpm.ui.part.tree.ActionTreeEditPart;

public class ActionContributor implements ElementContributor {
	...
	public EditPart createTreeEditPart(Element element) {
		return new ActionTreeEditPart((Action)element);
	}

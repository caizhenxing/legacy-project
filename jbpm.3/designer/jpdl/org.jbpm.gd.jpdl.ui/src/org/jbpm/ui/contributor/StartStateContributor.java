...
import org.jbpm.ui.part.tree.StartStateTreeEditPart;

public class StartStateContributor implements ElementContributor {
	...
	public EditPart createGraphicalEditPart(Element element) {
		return new NodeGraphicalEditPart((StartState)element);
	}

	public EditPart createTreeEditPart(Element element) {
		return new StartStateTreeEditPart((Node)element);
	}

	public IFigure createFigure() {
		return new NodeFigure("Start State", "Start");
	}

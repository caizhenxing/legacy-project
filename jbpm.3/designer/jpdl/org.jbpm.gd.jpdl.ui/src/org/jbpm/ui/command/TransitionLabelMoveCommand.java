...
public class TransitionLabelMoveCommand extends Command {

	TransitionLabel label = null;
	Point location = null;
	Figure parent = null;
	Point oldOffset = new Point();

	public TransitionLabelMoveCommand(TransitionLabel label, Figure parent,
			Point location) {
		this.label = label;
		this.parent = parent;

...
public class DesignerGraphicalEditorPage extends EditorPart {
	
	private DesignerEditor editor;
	private SashForm designerForm;
	private DesignerPaletteViewer designerPaletteViewer;
	private DesignerModelViewer designerModelViewer;
	private DesignerOutlineViewer outlineViewer;

	public DesignerGraphicalEditorPage(DesignerEditor editor) {
		this.editor = editor;
	}
	...
	private void addOutlineViewer() {
		setOutlineViewer(new DesignerOutlineViewer(editor));
	}
	
	private void addModelViewer() {
		setDesignerModelViewer(new DesignerModelViewer(editor));
		getDesignerModelViewer().createControl(designerForm);
	}
	
	private void addPaletteViewer() {
		setDesignerPaletteViewer(new DesignerPaletteViewer(editor));
	...
	public DesignerModelViewer getDesignerModelViewer() {
		return designerModelViewer;
	}
	

	public void setDesignerModelViewer(DesignerModelViewer designerModelViewer) {
		this.designerModelViewer = designerModelViewer;
	}
	

	public DesignerPaletteViewer getDesignerPaletteViewer() {
		return designerPaletteViewer;
	}
	

	public void setDesignerPaletteViewer(DesignerPaletteViewer designerPaletteViewer) {
		this.designerPaletteViewer = designerPaletteViewer;
	}
	

	public DesignerOutlineViewer getOutlineViewer() {
		return outlineViewer;
	}
	

	public void setOutlineViewer(DesignerOutlineViewer outlineViewer) {

...
public class PageFlowPaletteViewer extends PaletteViewer {
	
	private PageFlowEditor editor;
	
	public PageFlowPaletteViewer(PageFlowEditor editor) {
		this.editor = editor;
	}
	...
	private void initEditDomain(SashForm parent) {
		...
		editDomain.setPaletteRoot(new PageFlowPaletteRoot(editor));
	}

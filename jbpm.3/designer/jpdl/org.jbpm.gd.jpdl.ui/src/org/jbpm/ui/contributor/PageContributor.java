...
public class PageContributor implements ElementContributor {
	...
	public EditPart createGraphicalEditPart(Element element) {
		return new NodeGraphicalEditPart((Page)element);
	}

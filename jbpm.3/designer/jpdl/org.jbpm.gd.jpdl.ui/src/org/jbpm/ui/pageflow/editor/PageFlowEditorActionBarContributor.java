...
public class PageFlowEditorActionBarContributor extends
    ...
    private static final String[] TEXTEDITOR_ACTION_IDS = {
 	...
 	public void setActivePage(IEditorPart activeEditor) {
		...
		if (activeEditor instanceof PageFlowGraphicalEditorPage) {
			hookGlobalGraphicalEditorActions((PageFlowGraphicalEditorPage)activeEditor, actionBars);
	...
	private void hookGlobalGraphicalEditorActions(
			PageFlowGraphicalEditorPage part, IActionBars actionBars) {

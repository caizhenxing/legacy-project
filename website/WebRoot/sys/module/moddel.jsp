...
<script language="javascript">
  ...
  <body>
  <html:form action="/sys/module.do?method=delete"  method="post" target="contents" >
<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
  ...
  <tr>
    ...
    <html:submit onclick="window.close()"><bean:message bundle="sys" key="sys.delete"/></html:submit>

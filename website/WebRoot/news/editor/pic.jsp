...
<script language="javascript">
	function selPic(){
		window.open("../opernews.do?method=toupload","uploadImg","width=400,height=50");
	}
</script>
...
<table align=center>
<tr><td>图片地址：
<input type="text" id=a name=a size=35 value="">
</td></tr><tr>
          <td> 说明文字：
...
</fieldset></td><td width=80 align="center"><input type=submit value='   确定   ' id=Ok><br><br><input type=button value='   取消   ' onclick="window.close();"></td></tr>
<tr>
    <td>
<FIELDSET align=left>
<LEGEND align=left>上传本地图片</LEGEND>
<iframe class="TBGen" style="top:2px" ID="UploadFiles" src="../opernews.do?method=toupload" frameborder=0 scrolling=no width="350" height="25"></iframe>
</fieldset>
	</td>

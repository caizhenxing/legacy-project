...
<link rel="STYLESHEET" type="text/css" href="<bean:write name='imagesinsession'/>news//edit.css">
...
<div class="yToolbar"> 
  ...
  <div class="Btn" TITLE="全部选择" LANGUAGE="javascript" onclick="format('selectall')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/selectall.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="删除" LANGUAGE="javascript" onclick="format('delete')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/del.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="剪切" LANGUAGE="javascript" onclick="format('cut')"> <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/cut.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="复制" LANGUAGE="javascript" onclick="format('copy')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/copy.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="粘贴" LANGUAGE="javascript" onclick="format('paste')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/paste.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="撤消" LANGUAGE="javascript" onclick="format('undo')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/undo.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="恢复" LANGUAGE="javascript" onclick="format('redo')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/redo.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="插入表格" LANGUAGE="javascript" onclick="InsertTable()"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/table.gif" WIDTH="18" HEIGHT="18"> </div>
  <!--arrow add(by zhangfeng)
  <div class="BtnMenu" TITLE="表格操作" LANGUAGE="javascript">
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4editarrow.gif" WIDTH="5" HEIGHT="18"> </div>
    end-->
  <div class="Btn" TITLE="插入栏目框" LANGUAGE="javascript" onclick="FIELDSET()"> <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/fieldset.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入网页" LANGUAGE="javascript" onclick="iframe()"> <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/htm.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入图片" LANGUAGE="javascript" onclick="pic()"> <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/img.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
<!--   <iframe class="TBGen" style="top:2px" ID="UploadFiles" src="#" frameborder=0 scrolling=no width="250" height="25"></iframe> -->
  <div class="Btn" TITLE="插入flash多媒体文件" LANGUAGE="javascript" onclick="swf()"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/flash.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入视频文件，支持格式为：avi、wmv、asf" LANGUAGE="javascript" onclick="wmv()"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/wmv.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入RealPlay文件，支持格式为：rm、ra、ram" LANGUAGE="javascript" onclick="rm()"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/rm.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
    <div class="Btn" TITLE="插入超级连接" LANGUAGE="javascript" onclick="UserDialog('CreateLink')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/url.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="取消超级链接" LANGUAGE="javascript" onclick="UserDialog('unLink')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/nourl.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入普通水平线" LANGUAGE="javascript" onclick="format('InsertHorizontalRule')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/line.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入特殊水平线" LANGUAGE="javascript" onclick="hr()"> <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/sline.gif" WIDTH="18" HEIGHT="18"> 
  </div>
</div>
...
<div class="yToolbar"> 
  ...
  <div class="Btn" TITLE="左对齐" name="Justify" LANGUAGE="javascript" onclick="format('justifyleft')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/aleft.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="居中" name="Justify" LANGUAGE="javascript" onclick="format('justifycenter')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/acenter.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="右对齐" name="Justify" LANGUAGE="javascript" onclick="format('justifyright')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/aright.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
  <div class="Btn" TITLE="编号" LANGUAGE="javascript" onclick="format('insertorderedlist')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/num.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="项目符号" LANGUAGE="javascript" onclick="format('insertunorderedlist')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/list.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="减少缩进量" LANGUAGE="javascript" onclick="format('outdent')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/outdent.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="增加缩进量" LANGUAGE="javascript" onclick="format('indent')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/indent.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="删除文字格式" LANGUAGE="javascript" onclick="format('RemoveFormat')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/clear.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="保存"	LANGUAGE="javascript" onclick="save()"> <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/save.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
<!--   <div class="Btn" TITLE="插入flash多媒体文件" LANGUAGE="javascript" onclick="swf()"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4editflash.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入视频文件，支持格式为：avi、wmv、asf" LANGUAGE="javascript" onclick="wmv()"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4editwmv.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入RealPlay文件，支持格式为：rm、ra、ram" LANGUAGE="javascript" onclick="rm()"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4editrm.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div> -->
  <div class="Btn" TITLE="查看帮助" LANGUAGE="javascript" onclick="help()"> <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/help.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="简&rarr;繁" LANGUAGE="javascript" onclick="s2t();"><img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/st.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="繁&rarr;简" LANGUAGE="javascript" onclick="t2s();"><img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/ts.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
</div>
<div class="yToolbar"> 
  <div class="TBHandle"> </div>
  ...
  <div class="TBSep"></div>
  <div class="Btn" TITLE="字体颜色" LANGUAGE="javascript" onclick="foreColor()"> <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/fgcolor.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="加粗" LANGUAGE="javascript" onclick="format('bold')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/bold.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="斜体" LANGUAGE="javascript" onclick="format('italic')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/italic.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="下划线" LANGUAGE="javascript" onclick="format('underline')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/underline.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="上标" LANGUAGE="javascript" onclick="format('superscript')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/sup.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="下标" LANGUAGE="javascript" onclick="format('subscript')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/sub.gif" WIDTH="18" HEIGHT="18"> </div>
  
  <!--add by zhangfeng(系统当前时间)-->
  <div class="Btn" TITLE="插入系统当前日期" LANGUAGE="javascript" onclick="nowdate()">
  	<img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/date.gif" WIDTH="18" HEIGHT="18">
  </div>
  <div class="Btn" TITLE="插入系统当前时间" LANGUAGE="javascript" onclick="nowtime()">
  	<img class="Ico" src="<bean:write name='imagesinsession'/>news/img4edit/time.gif" WIDTH="18" HEIGHT="18">
  </div>
  <div class="TBSep"></div>
  <!--zf edit end-->
<!--   <div class="Btn" TITLE="插入超级连接" LANGUAGE="javascript" onclick="UserDialog('CreateLink')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4editurl.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="取消超级链接" LANGUAGE="javascript" onclick="UserDialog('unLink')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4editnourl.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入普通水平线" LANGUAGE="javascript" onclick="format('InsertHorizontalRule')"> 
    <img class="Ico" src="<bean:write name='imagesinsession'/>news/img4editline.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="插入特殊水平线" LANGUAGE="javascript" onclick="hr()"> <img class="Ico" src="../<bean:write name='imagesinsession'/>news/img4editsline.gif" WIDTH="18" HEIGHT="18"> 
  </div> -->

...
<html>
  <head>
    ...
    <title>My JSP 'newsStyleTest.jsp' starting page</title>
...
<%--  <tr>--%>
<%--    <td height="28" background="images/top.gif" class="zhi">&nbsp; 业务简介2</td>--%>
<%--  </tr>--%>
<%--  <tr>--%>
...
<table width="400" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="28" background="images/top.gif" class="zhi">&nbsp; </td>
  </tr>
  <tr>
    <td height="60" valign="middle" background="images/m.gif">
    <table width="90%" border="0" align="center" cellpadding="2" cellspacing="2">

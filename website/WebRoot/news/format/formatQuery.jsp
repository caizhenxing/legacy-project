...
<html:html locale="true">
  <head>
    ...
    <script language="javascript">
    	...
    	//查询
    	function query(){
    		document.forms[0].action = "../format.do?method=toFormatList";
  ...
  <body>
    ...
    <html:form action="/news/format" method="post">
		...
		<table width="70%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  <tr>
		    <td class="tdbgcolorqueryright">样式描述</td>
		    <td class="tdbgcolorqueryleft">
		    <html:text property="styleDescribe" styleClass="input"/>
		    </td>
		    <td class="tdbgcolorqueryright">模块</td>
		    <td class="tdbgcolorqueryleft"><html:text property="newsNum" styleClass="input"/></td>
		  </tr>
<%--		  <tr>--%>
...
<%--		  </tr>--%>
		  ...
		  <tr>
		    ...
		    <input name="btnAdd" type="button" class="bottom" value="添加" onclick="window.open('format.do?method=toFormatLoad&type=insert','windows','750.700,scrollbars=yes')"/>
		    </td>
		  </tr>

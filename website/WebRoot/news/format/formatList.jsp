...
<%--		    <td class="tdbgpiclist">结束时间</td>--%>
		  ...
		  <logic:iterate id="c" name="list" indexId="i">
			...
			%>
		  <tr>
		    <td class="<%=style%>"><bean:write name="c" property="styleDescribe" filter="true"/></td>
		    <td class="<%=style%>"><bean:write name="c" property="newsNum" filter="true"/></td>
		    <td class="<%=style%>"><bean:write name="c" property="showStyle"  filter="true"/></td>
...
<%--		    <a href="../callinFirewall.do?method=toCallinFireWallLoad&type=delete&id=<bean:write name='c' property='id'/>"><img alt="<bean:message bundle='pccye' key='sys.del'/>" src="<bean:write name='imagesinsession'/>sysoper/del.gif" width="16" height="16" border="0"  /></a>--%>
            <img alt="详细" src="<bean:write name='imagesinsession'/>sysoper/particular.gif" onclick="window.open('format.do?method=toFormatDetail&type=detail&id=<bean:write name='c' property='id'/>','windows','480.400,scrollbars=yes')" width="16" height="16" target="windows" border="0"/>
            <img alt="修改" src="<bean:write name='imagesinsession'/>sysoper/update.gif" onclick="window.open('format.do?method=toFormatLoad&type=update&id=<bean:write name='c' property='id'/>','windows','480.400,scrollbars=yes')" width="16" height="16" target="windows" border="0"/>
		    <img alt="删除" src="<bean:write name='imagesinsession'/>sysoper/del.gif" onclick="window.open('format.do?method=toFormatLoad&type=delete&id=<bean:write name='c' property='id'/>','windows','480.400,scrollbars=yes')" width="16" height="16" target="windows" border="0"/>
<%--		    </logic:equal>--%>
...
<%--		    &nbsp;--%>
		  ...
		  <tr>
		    <td colspan="6">
				<page:page name="formatpageTurning" style="first"/>
		    </td>
		  </tr>
		</table>
    </html:form>

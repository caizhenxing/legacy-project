...
<body>
	<html:form action="/oa/absenceWork.do" method="post">
		<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
			...
			<tr>
				<td colspan="4"  class="tdbgcolorloadbuttom"><input name="Submit" type="button" class="bottom" value="<bean:message bundle='sys' key='sys.submit'/>"  onclick="getvalue(userTwo)" /></td>
			</tr>
		</table>
	</html:form>
</body>

    ...
    <html:form action="/oa/assissant/doc" method="post">
		<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#d8d8e5">
		  ...
		  <tr>
		    ...
		    <td class="<%=style%>">
		    <bean:write name="c" property="folderName" filter="true"/>
		    </td>
		    ...
		    <td   class="<%=style%>">
		    <html:link action="/oa/assissant/doc.do?method=toDocLoad&type=detail" paramId="id" paramName="c" paramProperty="id" onclick="popUp('windows','',480,400)" target="windows">
		    <bean:message key="agrofront.oa.assissant.document.docManagerList.detail"/>
		    </html:link>
		    /&nbsp;

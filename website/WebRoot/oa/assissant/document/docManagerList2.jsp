    ...
    <html:form action="/oa/assissant/doc" method="post">
		<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#d8d8e5">
		  <tr class="tdbgpiclist">
		    ...
		    <td><bean:message key="agrofront.oa.assissant.document.docManagerList2.shenpiSign"/></td>
		  ...
		  <tr>
		    ...
		    <td class="<%=style%>"><logic:equal name="c" property="folderSign" value="W">´ýÉóÅú</logic:equal><logic:notEqual name="c" property="folderSign" value="W">ÆäËû</logic:notEqual></td>
		    <td   class="<%=style%>">
		    <html:link action="/oa/assissant/doc.do?method=toDocLoad&type=shenpi" paramId="id" paramName="c" paramProperty="id" onclick="popUp('windows','',480,400)" target="windows">
		    <bean:message key="agrofront.oa.assissant.document.docManagerList2.shenpi"/>
		    </html:link>
		    /&nbsp;

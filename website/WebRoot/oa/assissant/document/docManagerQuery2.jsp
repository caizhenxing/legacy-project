...
<html:html locale="true">
  <head>
    ...
    <title><bean:message key="agrofront.oa.assissant.document.docManagerQuery2.documentShenpi"/></title>
    ...
    <script language="javascript">
    	//≤È—Ø
    	function query(){
    		document.forms[0].action = "../doc.do?method=toDocList2";
  ...
  <body>
    ...
    <html:form action="/oa/assissant/doc" method="post">
		  ...
		  <tr>
		    ...
		    <bean:message key="agrofront.oa.assissant.document.docManagerQuery2.documentShenpi"/>
		    </td>
		  </tr>
		</table>

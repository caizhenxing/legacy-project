...
<head>
	...
	<title><bean:message key='hl.bo.oa.conference.selectEmployee'/></title>
	...
	<script language="JavaScript" type="text/JavaScript">
	  ...
	  function getvalue(oToList){
	     ...
	     par.synodPeople.value = str;
	     window.close();
	  }
	  
	  //Ñ¡Ôñ²¿ÃÅ
	  function query() {
        document.forms[0].action = "../absenceWork.do?method=toUserList&page=selectEmployee";
...
<body>
	<html:form action="/oa/assissant/conference/conferOper" method="post">
		<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
			<tr>
				<td colspan="4" class="tdbgpicload"><bean:message key="hl.bo.oa.checkwork.selectEmployee.list"/></td>
			</tr>
			...
			<tr>
				...
				<td class="tdbgcolorloadleft">
						<select name="userTwo" multiple id="userTwo" style="HEIGHT: 176px; WIDTH: 150px"></select>
				</td>
			</tr>
			<tr>
				<td colspan="3"  class="tdbgcolorloadbuttom"><input type="button" name="selectB" value="<bean:message bundle='sys' key='sys.submit'/>" onclick="getvalue(userTwo)"/></td>
			</tr>
		</table>
	</html:form>
</body>

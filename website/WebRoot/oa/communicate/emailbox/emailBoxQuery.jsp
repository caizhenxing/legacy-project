...
<html:html locale="true">
  <head>
    ...
    <script language="javascript">
    	//²éÑ¯
    	function query(){
    		document.forms[0].action = "../emailbox.do?method=toEmailBoxList";
    ...
    <html:form action="/oa/communicate/emailbox.do" method="post">
		<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
		    ...
		    <bean:message key="et.oa.communicate.emailbox.emailboxquery.boxmanager"/>
		    </td>
		  </tr>
		</table>
		<table width="70%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  <tr>
		    <td class="tdbgcolorqueryright"><bean:message key="et.oa.communicate.emailbox.emailboxquery.emailboxname"/></td>
		    <td class="tdbgcolorqueryleft"><html:text property="name" styleClass="input"/></td>
		    <td class="tdbgcolorqueryright"><bean:message key="et.oa.communicate.emailbox.emailboxquery.emailaddr"/></td>
		    <td class="tdbgcolorqueryleft"><html:text property="emailaddress" styleClass="input"/></td>
		  </tr>
		  ...
		  <tr>
		    ...
		    <input name="btnAdd" type="button" class="bottom" value="<bean:message key='agrofront.common.insert'/>" onclick="popUp('windows','emailbox.do?method=toEmailBoxLoad&type=insert',650,350)"/>
		    </td>
		  </tr>
		</table>
    </html:form>

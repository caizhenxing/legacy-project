    ...
    <html:form action="/oa/communicate/email.do" method="post">
		<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  ...
		  <tr>
		    ...
		    <logic:present name="adjunctInfo">
		    <input type="button" name="btnUpload" value="<bean:message key='agrofront.email.emailLoad.upload'/>" onclick="upload()" readonly="true"/>
		    </logic:present>
		  ...
		  <tr>
		    ...
		    <td class="tdbgcolorloadleft">
			<html:text property="takeList" size="50" styleClass="input" readonly="true"/>
		    </td>
		  </tr>
		  <tr>
		    <td class="tdbgcolorloadright"><bean:message key="agrofront.email.emailLoad.select"/></td>
		    <td class="tdbgcolorloadleft">
					<html:text property="copyList" size="50" styleClass="input" readonly="true"/>

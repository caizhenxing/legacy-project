...
<head>
	...
	<title><bean:message key="oa.communicate.im.personList"/></title>
...
<body>
	<html:form action="/oa/communicate/im.do" method="post">
		<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
			<tr>
				<td colspan="4" class="tdbgpicload"><bean:message key="oa.communicate.im.personList"/></td>
			</tr>
			...
			<tr>
				<td class="tdbgcolorloadright">
						<select ondbClick="javascript:moveOption(userFirst,userTwo,false)" name="userFirst" multiple id="userFirst" style="HEIGHT: 176px; WIDTH: 150px">
							...
							<option value="<bean:write name="userInfo" property="id"/>">
				...
				<td class="tdbgcolorloadleft">
						...
						<logic:iterate name="userList2" id="userInfo2">
							<option value="<bean:write name="userInfo2" property="id"/>">
								<bean:write name="userInfo2" property="name"/>
							</option>
							</logic:iterate>
						</select>
				</td>
			...
			<tr>
				<td colspan="4"  class="tdbgcolorloadbuttom">
						<html:button property="selectB"  onclick="getvalue(userTwo)" ><bean:message key="oa.communicate.im.submit"/></html:button>
				</td>
			</tr>
		</table>
	</html:form>

 ...
 */
package excellence.common.page;
...
public class PageTurning {
	...
	public PageTurning(PageInfo pageInfor, String proj,
		...
		this.basicUrl = addUrlParameter(this.basicUrl, actionMapping
				.getParameter(), request.getParameter(actionMapping
				.getParameter()));
	...
	private String doFirstPage() {
		...
		/*
		 * url =addUrlParameter(url, StrutsConst.IDUS, StrutsConst.IDUS_S);
		 */
		url = addUrlParameter(url, "pagestate", Integer.toString(page
				.getFirstPage()));
		return getUrl(url);
	}

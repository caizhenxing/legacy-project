 ...
 * 
 */
public class StateCaseServiceImpl implements StateCaseService {
	private BaseDAO dao;
	...
	public JFreeChart statistic(IBaseDTO dto) {
		...
		procSql.setProcedureName("");
		params.add(dto.get("beginTime").toString());
		params.add(dto.get("endTime").toString());
		params.add(dto.get("caseRid").toString());
		params.add(dto.get("stateType").toString());
		...
		properties.put("chartTitle", "各审核状态下的受理案件统计");
		// 各种图形的特定属性
		String xChartName="".equals(dto.get("caseRid"))?"工号":"时间";
		String yChartName="审查状态";

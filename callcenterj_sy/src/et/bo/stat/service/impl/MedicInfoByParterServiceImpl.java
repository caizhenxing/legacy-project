 ...
 * 
 */
public class MedicInfoByParterServiceImpl implements MedicInfoByParterService {
	private BaseDAO dao;
	...
	public JFreeChart statistic(IBaseDTO dto) {
		...
		procSql.setProcedureName("proc_medicInfoByParter");
		...
		properties.put("chartTitle", "参加新农合情况统计");
		// 各种图形的特定属性
		String yChartName="参加新农合数量";
		if (chartType.indexOf(JFreeImpl.BAR) >= 0) {
			properties.put("xChartName", "是否参加新农合");
	...
	public List<DynaBeanDTO> query(IBaseDTO dto) {
		...
		params.add("medic_rid");
		params.add("");
		params.add("oper_medicinfo");
		params.add("is_parter");

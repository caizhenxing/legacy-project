 ...
 * 
 */
public class InquiryStatisticsByAnswerImpl implements InquiryStatisticsByAnswerService {
	private BaseDAO dao;
	...
	public JFreeChart statistic(IBaseDTO dto) {
		...
		procSql.setProcedureName("proc_inquiryStatisticsByAnswer");
...
//		params.add(dto.get("name").toString());
		...
		properties.put("chartTitle", "每一调查问题下各答案的数量");
		// 各种图形的特定属性
		String yChartName="答案数量";

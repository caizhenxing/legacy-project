 ...
 * 
 */
public class MarkanaInfoByTypeImpl implements MarkanaInfoByTypeService {
	private BaseDAO dao;
	...
	public JFreeChart statistic(IBaseDTO dto) {
		...
		procSql.setProcedureName("proc_markanaInfoByType");
		...
		properties.put("chartTitle", "全部评别和各评别产品数量");
		// 各种图形的特定属性
		String yChartName="全部评别和各评别产品数量";
		if (chartType.indexOf(JFreeImpl.BAR) >= 0) {
			properties.put("xChartName", "评别");

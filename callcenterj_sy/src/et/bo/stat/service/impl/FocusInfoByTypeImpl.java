 ...
 * 
 */
public class FocusInfoByTypeImpl implements FocusInfoByTypeService {
	private BaseDAO dao;
	...
	public JFreeChart statistic(IBaseDTO dto) {
		...
		procSql.setProcedureName("proc_focusInfoByType");
		...
		properties.put("chartTitle", "全部版别和各版别的产品数量");
		// 各种图形的特定属性
		String yChartName="版别的产品数量";

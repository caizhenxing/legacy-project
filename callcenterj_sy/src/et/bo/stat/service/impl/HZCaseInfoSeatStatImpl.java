 ...
 * 
 */
public class HZCaseInfoSeatStatImpl implements HZCaseInfoSeatStatService {
	private BaseDAO dao;
	...
	public JFreeChart statistic(IBaseDTO dto) {
		...
		procSql.setProcedureName("proc_HZCaseInfoStatisticsBySeat_old");
...
//			properties.put("xChartName", "座席工号");
	...
	/**
	 * 	set @srcSql = 'select case_rid, case_time from oper_caseinfo
...
//		 TODO Auto-generated method stub
		...
		String temp=dto.get("workNum").toString();
		params.add("case_rid");
		params.add(temp);

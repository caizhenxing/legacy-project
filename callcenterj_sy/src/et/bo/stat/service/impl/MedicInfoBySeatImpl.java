 ...
 * 
 */
public class MedicInfoBySeatImpl implements MedicInfoBySeatService {
	private BaseDAO dao;
	...
	public JFreeChart statistic(IBaseDTO dto) {
		...
		procSql.setProcedureName("proc_medicInfoBySeat");
		...
		properties.put("chartTitle", "全部座席员和每一座席员受理的医疗服务次数");
		// 各种图形的特定属性
		String yChartName="座席员受理的医疗服务次数";

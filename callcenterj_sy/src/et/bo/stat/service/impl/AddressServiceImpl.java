...
import et.bo.stat.service.AddressService;
...
public class AddressServiceImpl implements AddressService {
	...
	public JFreeChart statistic(IBaseDTO dto) {
		...
		procSql.setProcedureName("proc_address");
		...
		properties.put("chartTitle", "来电量统计");
		// 各种图形的特定属性
		if (chartType.indexOf(JFreeImpl.BAR) >= 0) {
			properties.put("xChartName", "地区名称");
			properties.put("yChartName", "来电量");
...
//			System.out.println("record get(Sum1) is "+record.get("Sum1"));

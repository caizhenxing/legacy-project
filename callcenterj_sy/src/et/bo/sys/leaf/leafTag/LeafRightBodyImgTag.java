 ...
 * @author 王文权
 */
public class LeafRightBodyImgTag extends BodyTagSupport {
    	...
    	try
    	{
    		...
    		if(slr != null)
    		{
    			...
    			//if(this.getOnclick()!=null)
      			...
      			if(this.getSrc()!=null)
    				out.print(" src=\""+this.getSrc()+"\"");
    		}
    		else
    		{
    			if(this.getSrc()!=null)
    				out.print(" src=\""+getNonSrc(this.getSrc())+"\"");
    		}
	 ...
	 * @return
	 */
	private String getNonSrc(String src)
	{
		...
		if(dotIndex!=-1)
		{
			...
			if(lIndex!=-1)
			{
				String tmp = src.substring(0,lIndex);
				String name = src.substring(lIndex+1);
				return tmp+"/non"+name;
			}
			return "non"+src;
		}

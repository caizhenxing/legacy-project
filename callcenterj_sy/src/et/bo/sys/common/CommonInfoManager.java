...
public class CommonInfoManager {
	...
	// private static org.apache.commons.logging.Log log4j =
	// LogFactory.getLog(CommonInfoManager.class);
	 ...
	 * 
	 * @param user
	 *            a <code>String</code> is log's user id .
	 * @param operType
	 *            a <code>String</code> is log's type id .
	 * @param mod
	 *            a <code>String</code> is log's module id .
	 * @param ip
	 *            a <code>String</code> is log's ip .
	 * @param remark
	 *            a <code>String</code> is log's remark .
	 * @version 2006-8-29
	 */
//	public void addLog(String user, String operType, String mod, String ip,
//			String remark) {

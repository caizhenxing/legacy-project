...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/corpInfoByState.do?method=toDisplay"
	...
	<body class="conditionBody" onload="time()">
		<html:form action="/stat/corpInfoByState.do?method=toDisplay" method="post" target="bottomm">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr class="conditionoddstyle">
					...
					<td class="LabelStyle" align="center">
						<input type="button" name="btnSearch" class="buttonStyle" value="查询"  
							onclick="dodisplay()" />

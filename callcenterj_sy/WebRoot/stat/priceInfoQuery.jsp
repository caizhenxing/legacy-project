...
<html>
	...
	<html:base />
		...
		function dodisplay(){
			...
			document.forms[0].action="../stat/priceInfo.do?method=toDisplay"
	...
	<body class="conditionBody" onload="setTime()">
		<html:form action="/stat/priceInfo.do?method=toDisplay" method="post" target="bottomm">

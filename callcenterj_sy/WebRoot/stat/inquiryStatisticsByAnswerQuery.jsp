...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/inquiryStatisticsByAnswer.do?method=toDisplay"
	...
	<body class="conditionBody" onload="time">
		<html:form action="/stat/inquiryStatisticsByAnswer.do?method=toDisplay" method="post" target="bottomm">

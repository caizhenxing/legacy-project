...
<html:html>
  <head>
    ...
    <title>全部座席员和每一座席员受理的各审核状态下的企业信息数量</title>
  ...
  <body class="listBody">
		<table id="tbl1" width="100%" border="0" align="center" cellpadding="1"
		  ...
		  <tr>
		    ...
		    <td class="listTitleStyle" width="34%">服务次数(例)</td>
...
<%--					</td>--%>
		  		 ...
		  		 <tr>
					...
					<div style="text-align:right;">
						<input type="button" class="buttonStyle" value="导出Excel" onclick="parseTbl('tbl1','全部座席员和每一座席员受理的各审核状态下的企业信息数量','<%=basePath %>')" />
					</div>
					</td>
				</tr>
		</table>

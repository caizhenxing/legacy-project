...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/case.do?method=toDisplay"
	...
	<body class="conditionBody" onload="time()">
		<html:form action="/stat/case" method="post" target="bottomm">
...
<%--						<input class="buttonStyle" type="button" name="btnSearch" value="查询"  --%>
<%--							onclick="dodisplay()" />--%>
<%--					</td>--%>
<%--					</tr>--%>
					<tr>
					...
					<td class="valueStyle">
						<html:select property="caseType" styleClass="selectStyle" style="width:130px">
							<html:option value="big">大类</html:option>
							<html:option value="small">小类</html:option>
<%--							<html:option value="kinds">种类</html:option>--%>
						</html:select>
					</td>
					<td class="LabelStyle">
						生成
...
<%--							<input class="buttonStyle" type="reset" value="刷新"  >--%>
				...
				<tr>
					...
					<td class="valueStyle">
						<select name="caseAttr3" style="width:130px" class="selectStyle">

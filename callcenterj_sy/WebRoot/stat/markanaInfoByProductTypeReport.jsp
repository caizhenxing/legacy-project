  ...
  <body class="listBody">
		<table id="tbl1" width="100%" border="0" align="center" cellpadding="1"
		  ...
		  <tr>
		    ...
		    <td class="listTitleStyle" width="33%">责任编辑</td>
		    
		    
		    <td class="listTitleStyle" width="33%">评别</td>
		    
		    <td class="listTitleStyle" width="34%">产品数量(例)</td>
...
<%--					</td>--%>
					...
					<div style="text-align:right;">
						<input type="button" class="buttonStyle" value="导出Excel" onclick="parseTbl('tbl1','每一责任编辑各评别的产品数量','<%=basePath %>')" />
					</div>
					</td>
				</tr>
		</table>

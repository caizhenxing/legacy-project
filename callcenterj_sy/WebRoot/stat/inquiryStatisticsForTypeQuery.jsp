...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/inquiryStatisticsForType.do?method=toDisplay"
	...
	<body class="conditionBody" onload="time()">
		<html:form action="/stat/inquiryStatisticsForType" method="post" target="bottomm">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr class="conditionoddstyle">
					...
					<td class="valueStyle">
<%--						应该使用inquiryType但为了不修改commonForm(formbean)而使用已有的serviceType --%>
						<html:select property="serviceType" styleClass="selectStyle">

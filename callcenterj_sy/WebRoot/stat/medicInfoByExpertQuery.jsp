...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/medicInfoByExpert.do?method=toDisplay"
	...
	<body class="conditionBody" onload="setTime()">
		<html:form action="/stat/medicInfoByExpert.do?method=toDisplay" method="post" target="bottomm">

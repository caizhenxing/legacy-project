...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/commonStateCase.do?method=toDisplay"
	...
	<body class="conditionBody" onload="time()">
		<html:form action="/stat/commonStateCase" method="post" target="bottomm">
				...
				<tr class="conditionoddstyle">
					...
					<td class="valueStyle">
						<html:text property="beginTime" styleClass="writeTextStyle2"
							onclick="openCal('commonStateCaseForm','beginTime',false);" />
					...
					<td class="valueStyle">
						<html:text property="endTime" styleClass="writeTextStyle2"
							onclick="openCal('commonStateCaseForm','endTime',false);"/>
						<img alt="选择时间" src="../html/img/cal.gif"
					onclick="openCal('commonStateCaseForm','endTime',false);">
					</td>

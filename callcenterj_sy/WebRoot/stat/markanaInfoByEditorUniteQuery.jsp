...
<html>
	<head>
	<html:base />
		<title>市场分析库信息统计</title>
		<link href="../style/<%=styleLocation %>/style.css" rel="stylesheet" type="text/css" />
		<script language=javascript src="../js/calendar3.js"></script>
		<script>
		function dodisplay(){
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/markanaInfoByEditor.do?method=toUniteDisplay"
			document.forms[0].submit();
		}
		function dodisplay3d(){
			if(document.forms[0].chartType!=""){
			setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
				document.forms[0].action="../stat/markanaInfoByEditor.do?method=toDisplay";
				document.forms[0].submit();
			}
		}
		function setTime(){
	...
	<body class="conditionBody" onload="setTime()">
		<html:form action="/stat/markanaInfoByEditor.do?method=toDisplay" method="post" target="bottomm">

			<table width="100%" border="0" align="center" cellpadding="0"
				cellspacing="0" class="nivagateTable">
				<tr>
					<td class="navigateStyle">
						当前位置&ndash;&gt;座席编辑/评别量统计
					</td>
				</tr>
			</table>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr class="conditionoddstyle">
					...
					<td class="valueStyle">
						<html:hidden property="chartType" value="" />表格

...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/inquiryInfoByOrganization.do?method=toDisplay"
	...
	<body class="conditionBody" onload="time()">
		<html:form action="/stat/inquiryInfoByOrganization.do?method=toDisplay" method="post" target="bottomm">
...
<%--					</td>--%>
					...
					<td class="valueStyle">
<%--						应该使用organiztion但为了不修改commonForm(formbean)而使用已有的serviceType--%>

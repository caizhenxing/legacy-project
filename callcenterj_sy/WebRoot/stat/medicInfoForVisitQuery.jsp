...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/medicInfoForVisit.do?method=toDisplay"
	...
	<body class="conditionBody" onload="setTime()">
		<html:form action="/stat/medicInfoForVisit" method="post" target="bottomm">

			<table width="100%" border="0" align="center" cellpadding="0"
				cellspacing="0" class="nivagateTable">
				<tr>
					<td class="navigateStyle">
						当前位置&ndash;&gt;预约医疗服务信息库统计&ndash;&gt;是否就诊量统计
					</td>
				</tr>
			</table>

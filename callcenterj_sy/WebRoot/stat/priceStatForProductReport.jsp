...
<html:html>
  ...
  <body class="listBody">
		<table id="tbl1" width="100%" border="0" align="center" cellpadding="1"
		  ...
		  <tr>
		    <td class="listTitleStyle" width="20%">产地名称</td>
		    <td class="listTitleStyle" width="20%">产品名称</td>
		    <td class="listTitleStyle" width="20%">最大值</td>
		    <td class="listTitleStyle" width="20%">最小值</td>
...
<%--		    <td class="listTitleStyle">呼出<logic:equal name="condition" value="count">数量(个)</logic:equal><logic:notEqual name="condition" value="count">时长(秒)</logic:notEqual></td>--%>
		    <td class="listTitleStyle" width="20%">平均值</td>
		  </tr>
		  ...
		  <tr>
					<td >
						<bean:write name="c" property="address" filter="false" />
					</td>
					<td >
...
<%--					</td>--%>
					...
					<div style="text-align:right;">
						<input type="button" class="buttonStyle" value="导出Excel" onclick="parseTbl('tbl1','各产地各产品的价格最大值、最小值和平均值统计','<%=basePath %>')" />
					</div>
					</td>
				</tr>
		</table>

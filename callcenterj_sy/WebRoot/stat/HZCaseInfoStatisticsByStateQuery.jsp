...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/HZCaseInfoStatisticsByState.do?method=toDisplay"
	...
	<body class="conditionBody" onload="time()">
		<html:form action="/stat/HZCaseInfoStatisticsByState" method="post" target="bottomm">
				...
				<tr class="conditionoddstyle">
					...
					<td class="valueStyle">
						<html:text property="beginTime" styleClass="writeTextStyle"
							onclick="openCal('HZCaseInfoStatisticsByStateForm','beginTime',false);" size="10" />
						<img alt="选择时间" src="../html/img/cal.gif"
					onclick="openCal('HZCaseInfoStatisticsByStateForm','beginTime',false);">
					</td>
					<td class="LabelStyle">
						截止时间
					</td>
					<td class="valueStyle">
						<html:text property="endTime" styleClass="writeTextStyle"
							onclick="openCal('HZCaseInfoStatisticsByStateForm','endTime',false);" size="10" />
						<img alt="选择时间" src="../html/img/cal.gif"
					onclick="openCal('HZCaseInfoStatisticsByStateForm','endTime',false);">
					</td>
					<td class="LabelStyle">
<%--						座席工号--%>
						受理工号

...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/medicInfoForNavigator.do?method=toDisplay"
	...
	<body class="conditionBody" onload="setTime()">
		<html:form action="/stat/medicInfoForNavigator" method="post" target="bottomm">

			<table width="100%" border="0" align="center" cellpadding="0"
				cellspacing="0" class="nivagateTable">
				<tr>
					<td class="navigateStyle">
						当前位置&ndash;&gt;预约医疗服务信息库统计&ndash;&gt;导诊量统计
					</td>
				</tr>
			</table>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr class="conditionoddstyle">
					...
					<td class="valueStyle">
						<html:text property="navigator"></html:text>
					</td>
					<td class="LabelStyle">
						生成
					</td>

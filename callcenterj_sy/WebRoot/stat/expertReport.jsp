	...
	<table id="tbl1" width="100%" border="0" align="center" cellpadding="1" cellspacing="1" class="listTable">
		<tr class="listTitleStyle">
			...
			<logic:notEmpty name="querytype">
				<logic:equal name="querytype" value="统计次数">服务次数</logic:equal>
				<logic:equal name="querytype" value="统计时长">服务时长</logic:equal>
			</logic:notEmpty>
			
			<logic:empty name="querytype">统计情况</logic:empty>				
			</td>
		</tr>
		...
		<tr>
			<td colspan="2" class="listTitleStyle" align="right" style="margin:0px;padding-right:0px;">
				<div style="text-align:right;">
					<input type="button" class="buttonStyle" value="导出结果" onclick="parseTbl('tbl1','专家接听统计','<%=basePath%>')" />
				</div>
			</td>
		</tr>
	</table>

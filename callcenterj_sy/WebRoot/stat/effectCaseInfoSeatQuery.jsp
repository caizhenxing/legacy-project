...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/effectCaseInfoSeat.do?method=toDisplay"
	...
	<body class="conditionBody" onload="time()">
		<html:form action="/stat/effectCaseInfoSeat" method="post" target="bottomm">
...
<%--				</td></tr>--%>
					...
					<td class="valueStyle">
						<html:text property="beginTime" styleClass="writeTextStyle2"
							onclick="openCal('effectCaseInfoSeatForm','beginTime',false);" />
					...
					<td class="valueStyle">
						<html:text property="endTime" styleClass="writeTextStyle2"
							onclick="openCal('effectCaseInfoSeatForm','endTime',false);"/>
						<img alt="选择时间" src="../html/img/cal.gif"
					onclick="openCal('effectCaseInfoSeatForm','endTime',false);">
					</td>
					<td class="LabelStyle">

...
<html>
	...
	<body class="conditionBody" onload="time()">
		<html:form action="/stat/focusInfoAllEditor.do?method=toDisplay" method="post" target="bottomm">

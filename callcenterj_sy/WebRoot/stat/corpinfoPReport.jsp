  ...
  <body class="listBody">
		<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" class="listTable" id="changeColorTbl">
		  <tr class="tdbgpiclist">
		    <td class="listTitleStyle" width="33%">时间</td>
		    <td class="listTitleStyle" width="33%">服务类型</td>
		    <td class="listTitleStyle" width="34%">服务类型统计</td>
...
<%--		    <td class="tdbgpiclist">总话务量</td>--%>
		  ...
		  <tr align="center" >
					<td>
						<bean:write name="c" property="time" filter="false" />
					</td>
					<td>
						<bean:write name="c" property="serverType" filter="false" />
					</td>
					<td>
						<bean:write name="c" property="serverTypeSum" filter="false" />
					</td>
					<%--<td>
				...
				--%></tr>
					...
					<div style="text-align:right;">
						<input type="button" class="buttonStyle" value="导出Excel" onclick="parseTbl('changeColorTbl','企业服务信息使用率统计','<%=basePath %>')" />
					</div>
					</td>
				</tr>
		</table>

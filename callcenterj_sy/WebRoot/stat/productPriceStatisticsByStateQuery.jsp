...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/productPriceStatisticsByState.do?method=toDisplay"
	...
	<body class="conditionBody" onload="setTime()">
		<html:form action="/stat/productPriceStatisticsByState" method="post" target="bottomm">
				...
				<tr class="conditionoddstyle">
					...
					<td class="valueStyle">
						<html:text property="beginTime" styleClass="writeTextStyle2"
							onclick="openCal('productPriceStatisticsByStateForm','beginTime',false);" />
					...
					<td class="valueStyle">
						<html:text property="endTime" styleClass="writeTextStyle2"
							onclick="openCal('productPriceStatisticsByStateForm','endTime',false);"/>
						<img alt="选择时间" src="../html/img/cal.gif"
					onclick="openCal('productPriceStatisticsByStateForm','endTime',false);">
					</td>

  ...
  <body class="listBody">
		<table id="tbl1" width="100%" border="0" align="center" cellpadding="1"
		  ...
		  <tr>
		    ...
		    <td class="listTitleStyle" width="25%">均价 （单位：元）</td>
		    <td class="listTitleStyle" width="25%">最高价（单位：元）</td>
		    <td class="listTitleStyle" width="25%">最低价（单位：元）</td>
		  </tr>
		  ...
		  <tr>
					...
					<div style="text-align:right;">
						<input type="button" class="buttonStyle" value="导出Excel" onclick="parseTbl('tbl1','农产品价格库统计','<%=basePath %>')" />
					</div>
					</td>
				</tr>
		</table>

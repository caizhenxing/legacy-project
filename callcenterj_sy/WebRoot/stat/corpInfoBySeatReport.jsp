...
<html:html>
  <head>
    ...
    <title>全部座席员和每一座席员受理企业服务次数</title>
  ...
  <body class="listBody">
		<table id="tbl1" width="100%" border="0" align="center" cellpadding="1"
		  ...
		  <tr>
		    ...
		    <td class="listTitleStyle">原始(条)</td>
		    <td class="listTitleStyle">待审(条)</td>
		    <td class="listTitleStyle">驳回(条)</td>
		    <td class="listTitleStyle">已审(条)</td>
		    <td class="listTitleStyle">发布(条)</td>
...
<%--					</td>--%>
		  		 ...
		  		 <tr>
					...
					<div style="text-align:right;">
						<input type="button" class="buttonStyle" value="导出Excel" onclick="parseTbl('tbl1','全部座席员和每一座席员受理企业服务次数','<%=basePath %>')" />
					</div>
					</td>
				</tr>
		</table>

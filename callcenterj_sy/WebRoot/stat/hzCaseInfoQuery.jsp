...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/hzCaseInfo.do?method=toDisplay"
	...
	<body class="conditionBody" onload="time()">
		<html:form action="/stat/hzCaseInfo" method="post" target="bottomm">
...
<%--				</td></tr>--%>
					...
					<td class="valueStyle">
						<html:text property="beginTime" styleClass="writeTextStyle"
							onclick="openCal('hzCaseInfoForm','beginTime',false);" />
					...
					<td class="valueStyle">
						<html:select property="condition" styleClass="selectStyle" style="width:130px">
							<html:option value="big">大类</html:option>
							<html:option value="small">小类</html:option>
						</html:select>
					</td>
					<td class="LabelStyle">
						生成
				...
				<tr>
					...
					<td class="valueStyle">
						<html:text property="endTime" styleClass="writeTextStyle"
							onclick="openCal('hzCaseInfoForm','endTime',false);"/>
						<img alt="选择时间" src="../html/img/cal.gif"
					onclick="openCal('hzCaseInfoForm','endTime',false);">
					</td>
					<td class="LabelStyle">
					...
					<td class="valueStyle">
						<select name="caseAttr3" style="width:130px" class="selectStyle" style="width:130px">
							<option value="0" selected="selected">请选择...</option>
							<option value="品种介绍">品种介绍</option>
							<option value="栽培管理">栽培管理</option>
							<option value="养殖管理">养殖管理</option>
							<option value="疫病防治">疫病防治</option>
							<option value="虫草防除">虫草防除</option>
							<option value="收获贮运">收获贮运</option>
							<option value="产品加工">产品加工</option>
							<option value="市场行情">市场行情</option>
							<option value="饲料配制">饲料配制</option>
							<option value="农资使用">农资使用</option>
							<option value="设施修建">设施修建</option>
							<option value="政策管理">政策管理</option>
							<option value="其他综合">其他综合</option>
						</select>
					</td>
					<td class="LabelStyle">
						受理工号

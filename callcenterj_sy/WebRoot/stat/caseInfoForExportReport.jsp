...
%>
  ...
  <body class="listBody">
		<table id="tbl1" width="100%" border="0" align="center" cellpadding="1"
			  ...
			  <tr>
			<td class="listTitleStyle" width="80px"><%=request.getAttribute("cTitle") %></td>
			...
			%>
	         <tr>
					...
					<div style="text-align:right;">
						<input type="button" class="buttonStyle" value="导出Excel" onclick="parseTbl('tbl1','专家受理案例统计','<%=basePath %>')" />
					</div>
					</td>
				</tr>
		</table>

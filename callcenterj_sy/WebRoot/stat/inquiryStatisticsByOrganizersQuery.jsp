...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/inquiryStatisticsByOrganizers.do?method=toDisplay"
	...
	<body class="conditionBody" onload="time()">
		<html:form action="/stat/inquiryStatisticsByOrganizers.do?method=toDisplay" method="post" target="bottomm">
...
<%--					</td>--%>
					...
					<td class="valueStyle">
<%--						应该使用organizers但为了不修改commonForm(formbean)而使用已有的serviceType--%>
						<html:text property="serviceType" styleClass="writeTextStyle" size="12"/>
					</td>
					<td class="LabelStyle">
						生成
					</td>

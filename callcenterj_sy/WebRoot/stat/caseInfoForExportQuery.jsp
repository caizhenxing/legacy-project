...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../sate/caseinfoForExport.do?method=toDisplay"
	...
	<body class="conditionBody" onload="time()">
		<html:form action="/sate/caseinfoForExport" method="post" target="bottomm">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr class="conditionoddstyle">
					...
					<td class="valueStyle">
						<html:select property="chartType" styleClass="selectStyle" style="width:130px">

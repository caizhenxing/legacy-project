...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/focusInfoOneEditor.do?method=toDisplay"
	...
	<body class="conditionBody" onload="time()">
		<html:form action="/stat/focusInfoOneEditor.do?method=toDisplay" method="post" target="bottomm">

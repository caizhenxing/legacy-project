...
<html>
	<head>
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/bookMedicinfoP.do?method=tobookMedicinfoPDisplay"
	...
	<body class="conditionBody" onload="time()">
		<html:form action="/stat/bookMedicinfoP" method="post" target="bottomm">

			<table width="100%" border="0" align="center" cellpadding="0"
				cellspacing="0" class ="nivagateTable">
				<tr>
					<td class="navigateStyle">
						当前位置&ndash;&gt;预约医疗使用率统计
					</td>
				</tr>
			</table>
			...
			<table width="100%" border="0" align="center" cellpadding="1"
				...
				<tr>
					...
					onclick="openCal('bookMedicinfoPForm','beginTime',false);">
					</td>
					<td class="queryLabelStyle">
						截止时间
					</td>
					<td class="valueStyle">
						<html:text property="endTime" styleClass="writeTextStyle2"/>
							<img alt="选择时间" src="../html/img/cal.gif"
					onclick="openCal('bookMedicinfoPForm','endTime',false);">
					</td>

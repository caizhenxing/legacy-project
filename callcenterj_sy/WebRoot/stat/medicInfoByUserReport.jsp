		...
		<table id="tbl1" width="100%" border="0" align="center" cellpadding="1"
		  ...
		  <tr>
		  	<logic:equal value="null" name="name">
		  		 <td class="listTitleStyle">用户姓名</td>
		  	</logic:equal>
		   <logic:equal value="notnull" name="name">
		  		 <td class="listTitleStyle" >咨询时间</td>
		  	</logic:equal>
		  ...
		  <tr>
		  	...
		  	<tr>
					...
					<div style="text-align:right;">
						<input type="button" class="buttonStyle" value="导出Excel" onclick="parseTbl('tbl1','各用户接受医疗服务次数统计','<%=basePath %>')" />
					</div>
					</td>
				</tr>
		</table>

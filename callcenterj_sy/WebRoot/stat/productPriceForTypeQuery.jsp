...
<html>
	...
	<html:base />
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/productPriceStatForServiceType.do?method=toDisplay"
	...
	<body class="conditionBody" onload="setTime()">
		<html:form action="/stat/productPriceStatForServiceType" method="post" target="bottomm">
			...
			<table width="100%" border="0" align="center" cellpadding="01"
				...
				<tr>
					...
					<td class="valueStyle">
<%--					应该使用custId但为了不修改commonForm(formbean)而使用已有的agentId--%>
						<html:text property="agentId" styleClass="writeTextStyle" />						
					</td>

  ...
  <body class="listBody">
		<table id="tbl1" width="100%" border="0" align="center" cellpadding="1"
		  ...
		  <tr>
		    ...
		    <td class="listTitleStyle">产品推介(个)</td>
		    <td class="listTitleStyle">售后服务(个)</td>
		    <td class="listTitleStyle">电话调查(个)</td>
		    <td class="listTitleStyle">信箱广告(个)</td>
		    <td class="listTitleStyle">产品销售(个)</td>
		    <td class="listTitleStyle">合计(个)</td>
		  </tr>
		  ...
		  <tr>
					...
					<div style="text-align:right;">
						<input type="button" class="buttonStyle" value="导出Excel" onclick="parseTbl('tbl1','各服务类型下的企业信息统计','<%=basePath %>')" />
					</div>
					</td>
				</tr>
		</table>

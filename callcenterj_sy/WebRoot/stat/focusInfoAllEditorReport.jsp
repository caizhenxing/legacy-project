  ...
  <body class="listBody">
		<table id="tbl1" width="100%" border="0" align="center" cellpadding="1"
		  ...
		  <tr>
		  	...
		  	<td class="listTitleStyle" >领导批示</td>	   
<%--		    <td class="listTitleStyle" >初稿(期)</td>--%>
<%--		    <td class="listTitleStyle">一审(期)</td>--%>
<%--		    <td class="listTitleStyle">二审(期)</td>--%>
<%--		    <td class="listTitleStyle">三审(期)</td>--%>
<%--		    <td class="listTitleStyle">发布(期)</td>--%>
<%--		    <td class="listTitleStyle">合计(期)</td>--%>

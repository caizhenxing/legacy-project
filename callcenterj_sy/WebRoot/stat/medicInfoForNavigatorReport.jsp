...
<%--						<input type="button" class="buttonStyle" value="导出Excel" onclick="parseTbl('tbl1','导诊员导诊次数','<%=basePath %>')" />--%>
<%--					</div>--%>
<%--					</td>--%>
<%--				</tr>--%>
<%--		</table>--%>
	<table id="tbl1" width="100%" border="0" align="center" cellpadding="1"
	 ...
	 <tr>
		    ...
		    <td class="listTitleStyle" >导诊量（例）</td>
		  </tr>
		  <logic:iterate id="c" name="list" indexId="i">
			<%
				String style =i.intValue()%2==0?"oddStyle":"evenStyle";
...
<script language="javascript">
	var sum = getSumCol(1,1,'tbl1');
	document.getElementById('sumCol').innerText = sum;
</script>
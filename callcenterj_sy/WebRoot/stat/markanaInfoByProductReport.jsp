		...
		<table id="tbl1" width="100%" border="0" align="center" cellpadding="1"
		  ...
		  <tr>
		  	...
		  	<logic:equal value="null" name="name">
		    	<td class="listTitleStyle" >品种</td>
		    </logic:equal>
		    <td class="listTitleStyle">周评</td>
		    <td class="listTitleStyle">月评</td>
		    <td class="listTitleStyle">季评</td>		    
		    <td class="listTitleStyle">年评</td>		    
		    <td class="listTitleStyle">合计(篇)</td>
...
<%--					</td>--%>
					...
					<div style="text-align:right;">
						<input type="button" class="buttonStyle" value="导出Excel" onclick="parseTbl('tbl1','全部品种和各品种的产品数量','<%=basePath %>')" />
					</div>
					</td>
				</tr>
		</table>

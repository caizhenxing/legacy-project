...
<html>
	<head>
		...
		setSameDateTime(document.forms[0].beginTime,document.forms[0].endTime);
			document.forms[0].action="../stat/hzCaseInfoSeat.do?method=toDisplay"
	...
	<body class="conditionBody" onload="time()">
		<html:form action="/stat/hzCaseInfoSeat" method="post" target="bottomm">
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="conditionTable">
				...
				<tr>
					...
					<td class="valueStyle">
						<html:text property="beginTime" styleClass="writeTextStyle" onclick="openCal('hzCaseInfoSeatForm','beginTime',false);" size="10" />
						<img alt="选择时间" src="../html/img/cal.gif" onclick="openCal('hzCaseInfoSeatForm','beginTime',false);">
						<br>
					</td>
					<td class="LabelStyle">
						截止时间
					...
					<td class="valueStyle">
						<html:text property="endTime" styleClass="writeTextStyle" onclick="openCal('hzCaseInfoSeatForm','endTime',false);" size="10" />
						<img alt="选择时间" src="../html/img/cal.gif" onclick="openCal('hzCaseInfoSeatForm','endTime',false);">
						<br>
					</td>
					<td class="LabelStyle">
<%--						座席工号--%>
					...
					<%--							<html:option value="class1">大类</html:option>--%>
					<%--							<html:option value="class2">小类</html:option>--%>
					<%--							<html:option value="class3">种类</html:option>--%>
					<%--						</html:select>--%>
					<%--					</td>--%>
					...
					<td class="LabelStyle" align="center">
						<input type="button" name="btnSearch" value="统计" onclick="dodisplay()" />

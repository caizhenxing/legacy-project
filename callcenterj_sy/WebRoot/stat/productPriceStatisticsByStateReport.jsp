  ...
  <body class="listBody">
		<table 	id="tbl1" width="100%" border="0" align="center" cellpadding="1"
		  ...
		  <tr>
		    ...
		    <logic:empty name="caseRid">工号</logic:empty>
		    <logic:notEmpty name="caseRid">时间</logic:notEmpty>
		    </td>
		    <td class="listTitleStyle" width="50%">状态</td>
		  </tr>
...
<%--					</td>--%>
					...
					<div style="text-align:right;">
						<input type="button" class="buttonStyle" value="导出Excel" onclick="parseTbl('tbl1','座席员受理的各审核状态下的产品供求数量统计','<%=basePath %>')" />
					</div>
					</td>
				</tr>
		</table>

...
<script type="text/javascript">
		function init(){
			...
			document.forms[0].action = "callOutSet.do?method=textSetOper";
		}
		$(document).ready(function(){
			...
			$("#textContent").formValidator({onshow:"请输入呼叫内容",onfocus:"呼叫内容不能为空",oncorrect:"呼叫内容合法"}).inputValidator({min:1,empty:{leftempty:false,rightempty:false,emptyerror:"呼叫内容两边不能有空符号"},onerror:"呼叫内容不能为空"});
...
<%--     </div>--%>
   ...
   <tr>
     ...
     <td class="valueStyle" colspan="3">
      <html:textarea property="textContent" cols="50" rows="10" styleId="textContent">
      </html:textarea>
      <div id="textContentTip" style="width: 150px;display:inline;"></div>
     </td>
   </tr>
...
<%--      <input type="button" name="Submit" id="Submit" value="提 交" onClick="add()" class="buttonStyle" />--%>
      ...
      <input type="reset" name="Submit2" id="buttonReset" value="重 置" class="buttonStyle" />

	...
	<html:form action="/callcenter/cclog" method="post">
		...
		<table width="100%" border="0" align="center" cellpadding="1"
			...
			<tr>
				...
				<td class="valueStyle">
					<html:text property="ringBegintime" styleClass="writeTextStyle2"
						readonly="true" />
					<img alt="选择时间" src="../../html/img/cal.gif"
						onclick="openCal('cclogMainBean','ringBegintime',false);">
					&nbsp;
			...
			<tr>
				...
				<td class="valueStyle">
					<html:text property="processEndtime" styleClass="writeTextStyle2"
						readonly="true" />
					<img alt="选择时间" src="../../html/img/cal.gif"
						onclick="openCal('cclogMainBean','processEndtime',false);">
					&nbsp;
					<html:select property="beginHour">
						<option value="">请选择</option>
						<html:option value="0"></html:option>

    ...
    <html:form action="/pcc/cclog.do" method="post" onsubmit="query()">
		...
		<table width="70%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  <tr>
		    ...
		    <img src="<%=request.getContextPath()%>/html/time.gif" width="20" height="20" onclick="openwin(beginTime)"/></td>
		    ...
		    <img src="<%=request.getContextPath()%>/html/time.gif" width="20" height="20" onclick="openwin(endTime)"/></td>
		  </tr>
		  <tr>

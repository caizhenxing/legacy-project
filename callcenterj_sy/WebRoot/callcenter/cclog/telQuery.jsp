...
<body class="conditionBody" onload="document.forms[0].btnSearch.click()">
	...
	<html:form action="/callcenter/cclog/telQuery.do?method=toTelQuery" method="post">
			...
			<tr>
				...
				<td class="valueStyle">
					...
					<img alt="选择时间" src="../../html/img/cal.gif"
						onclick="openCal('TelForm','beginTime',false);">
					&nbsp;
				...
				<td class="valueStyle">
					<html:text property="endTime" styleClass="writeTextStyle2"
						/>
					<img alt="选择时间" src="../../html/img/cal.gif"
						onclick="openCal('TelForm','endTime',false);">
					时

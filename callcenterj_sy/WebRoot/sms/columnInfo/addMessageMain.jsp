...
<html:html lang="true">
  ...
  <frameset name="dict" rows="10%,*" border="0" frameborder="0"  framespacing="0">
  	<frame name="topp" scrolling="no" src="columnInfo.do?method=toMessageQuery" noresize>
  	<frame name="bottomm" scrolling="no" src="columnInfo.do?method=toMessageList" noresize>
  <noframes>
  <body>　

...
<%--		opener.parent.bottomm.document.execCommand('Refresh');--%>
		opener.parent.topp.document.all.Submit4.click();
	</script>
	</logic:equal>
</logic:notEmpty>
    ...
    <html:form action="/sms/columnInfo" method="post">
    	<table width="100%" border="0" align="center" cellpadding="0"
			...
			cellspacing="1" class="contentTable">
				<tr>
					...
					<td class="valueStyle">
						<html:text property="columnInfo"></html:text>
					</td>
					<td class="labelStyle" align="center">
						<input type="button" name="btnUpdate" class="buttonStyle"
							value="添加" onclick="insert()" />
						<input type="reset" name="btnUpdate" class="buttonStyle"
							value="刷新" onclick="insert()" />
					</td>
				</tr>
			</table>
		--%><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" class="listTable">
		  ...
		  <tr>
			...
			<td ><bean:write name="c" property="sendTime" filter="true"/></td>
		   	<td >
		   		<img alt="设定发送时间" src="../../style/<%=styleLocation %>/images/update.png"
		    	onclick="popUp('1<bean:write name='c' property='columnInfo'/>','columnInfo.do?method=toColumnInfoTimeSet&colInfo=<bean:write name='c' property='columnInfo'/>&nickname=<bean:write name='c' property='nickname'/>',700,160)" width="16" height="16" border="0"/>
		    	<img alt="修改栏目" src="../../style/<%=styleLocation %>/images/update.gif"
		    	onclick="popUp('2<bean:write name='c' property='columnInfo'/>','columnInfo.do?method=toColumnInfoTimeSet&type=set&colInfo=<bean:write name='c' property='columnInfo'/>&nickname=<bean:write name='c' property='nickname'/>',700,160)" width="16" height="16" border="0"/>
		   	</td>
		  </tr>
		  </logic:iterate>
<%--		  <tr>--%>

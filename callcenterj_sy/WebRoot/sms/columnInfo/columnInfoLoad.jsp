	...
	function comptime(beginTime,endTime)
    {
			...
			else
			{
				...
				function cancel()
				{
			 		...
			 		document.forms[0].action="../columnInfo.do?method=toColumnInfoCustomize&type=cancel&orderType=<%=ot%>";
				...
				function update()
				{
			 		...
			 		document.forms[0].action="../columnInfo.do?method=toColumnInfoCustomize&type=update&orderType=<%=ot%>";
				...
				function del()
				{
			 		document.forms[0].action="../columnInfo.do?method=toColumnInfoCustomize&type=delete&orderType=<%=ot%>";

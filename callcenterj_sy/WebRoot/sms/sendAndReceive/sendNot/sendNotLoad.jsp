...
function delOper()
{
	document.forms[0].action="../sendNot.do?method=toSendNotOper&type=delete";		
    	...
    	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="contentTable">
    		<tr>
	    			...
	    			<td id="fontStyle" class="valueStyle">
	    				<bean:write name="sendNotBean" property="receiveNum"/>
	    			</td>
	    	</tr>
<%--	    	<tr>--%>
<%--	    			<td class="labelStyle">--%>
...
<%--	    			</td>--%>
<%--	    			<td id="fontStyle" class="valueStyle">--%>
<%--	    					<bean:write name="sendNotBean" property="operCount"/>--%>
<%--	    			</td>--%>
<%--	    	</tr>--%>
	    	<tr>
	    			<td class="labelStyle">
	    			...
	    			<td id="fontStyle" class="valueStyle">
	    					<bean:write name="sendNotBean" property="schedularTime"/>
	    			</td>
	    	</tr>
	    	<tr>
	    			<td class="labelStyle">
	    			...
	    			<td id="fontStyle" class="valueStyle">
	    					<bean:write name="sendNotBean" property="management"/>
	    			</td>
	    	</tr>
	    	<tr>
	    			<td class="labelStyle">
	    			...
	    			<td id="fontStyle" class="valueStyle">
	    					<bean:write name="sendNotBean" property="content"/>
	    			</td>
	    	</tr>
	    	<tr>

		...
		$.post(
			...
			function(data){
				...
				for(var key in result){
            			...
            			var str = '<tr>';
            			str = str + '<td width=1258 class=Even>';
...
<body>
	<!--begin-->
         <table width="1258" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="1258" height="24" class="Title"><img src="images/traffic statistics2.jpg" width="12" height="13">金农热线</td>
            </tr>
          </table>
           
          <div id="marquees">          
          <table id="marqueeTableId"  border="0" align="center" cellpadding="0" cellspacing="0">            
            <tr class="templeteRow">
              <td width="1258" class="Even" >1</td>
            </tr>            
          </table>          
          </div>
          <!--end--> 

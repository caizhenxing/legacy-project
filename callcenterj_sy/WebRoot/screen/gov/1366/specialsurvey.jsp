...
<body>
          ...
          <table width="1258" height="20" border="0"  cellpadding="0" cellspacing="0">
            <tr>
              <td width="321" height="24" class="Title"><img src="images/traffic statistics2.jpg" width="12" height="13">调查基本信息</td>
              <td width="938" class="Title"><img src="images/traffic statistics2.jpg" width="12" height="13">调查分析报告</td>
            </tr>
           </table>
          <div id="marquees">
          <table id="marqueeTableId" width="1258" height="598" border="0" align="center" cellpadding="0" cellspacing="0">
...
<script language="javascript">
		new Marquee("marquees","top",1,1280,550,30,1000);
</script>
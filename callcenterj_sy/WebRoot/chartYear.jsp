...
<body onload="setPosition()" onresize="changePosition()"><br><br><br><br><br><br><br>
<table width="98%" border="0" cellspacing="0" cellpadding="3" align="center">
  <tr> 
    <td valign="top" class="text" align="center"> 
    
    <div id="chartdiv" align="center" style="background-color:blue;width:600px;"></div>
    <div id="coverTopDiv"  style="z-index:999;border:none;padding:0px;position:absolute;margin-top:-2px;width: 500px;height:20;top:0;left:0;background-color:red;background:#cccccc   url(./images/chart02.jpg);"></div>
      <script type="text/javascript">
		   var chart = new FusionCharts("./css/charts/Column2D.swf", "ChartId", "600", "350", "0", "0");

...
<%-- 		document.forms[0].submit();--%>
		...
		popUp(num,'operpriceinfo.do?method=toStatisticForwardAction&statisticType='+type,800,460);
				...
				<td class="LabelStyle">
					...
					<td class="valueStyle">
						<html:select property="statisticType" styleClass="selectStyle">
							<html:option value="agent">座席受理量统计</html:option>
<%--							<html:option value="priceType">价格类型量统计</html:option>--%>
							<html:option value="priceCount">产品价格量统计</html:option>
							<html:option value="StatisticsByServiceType">联络员报价统计</html:option>
							<html:option value="addressPrice">产地产品最值/均值统计</html:option>
<%--							<html:option value="priceMMA">时间产品最值/均值统计</html:option>--%>
						</html:select>
					</td>

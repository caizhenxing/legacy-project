...
<%-- 		document.forms[0].submit();--%>
		...
		popUp(num,'markanainfo.do?method=toStatisticForwardAction&statisticType='+type,800,460);
...
<%--								<html:option value="ByEditorType">座席编辑量统计</html:option>--%>
								<html:option value="ByEditorType">产品编辑量统计</html:option>
<%--							<html:option value="ByEditor">座席编辑量统计</html:option>--%>
<%--							<html:option value="AllEditor">座席品种量统计</html:option>--%>
<%--							<html:option value="ByType">产品评别量统计</html:option>--%>
							<html:option value="OneEditor">品种编辑量统计</html:option>

	...
	<script type="text/javascript">
		...
		function init(){
			<logic:equal name="opertype" value="insert">
					...
					document.forms[0].action = "../focusPursue.do?method=toFocusPursue&type=insert";
   			...
   			<logic:equal name="opertype" value="update">
					...
					document.forms[0].action = "../focusPursue.do?method=toFocusPursue&type=update";
					document.getElementById('btnOper').value="修改";
					document.getElementById('btnOper').style.display="inline";
   			</logic:equal>
   			<logic:equal name="opertype" value="delete">
   					document.getElementById('spanHead').innerHTML="删除信息";
					document.forms[0].action = "../focusPursue.do?method=toFocusPursue&type=delete";
    	...
    	$(document).ready(function(){
			...
			$("#dictFocusType").formValidator({empty:false,onshow:"请选择版别",onfocus:"版别必须选择",oncorrect:"OK!"}).inputValidator({empty:false,min:1,onerror: "没有选择版别"});
...
<body onunload="toback()" class="loadBody" onload="init()">
	...
	<html:form action="/focusPursue.do" method="post" styleId="formValidate">
...
<%--		    	</logic:equal>--%>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			cellspacing="1" class="contentTable">
			<%
			String id2 = (String) ((excellence.framework.base.dto.IBaseDTO) request.getAttribute("focusPursueBean")).get("focusId");
			String p2 = "../upload/ico.jsp?t=oper_focusinfo.focus_id&id=" + id2;
			%>
			<tr>
				...
				<logic:notEmpty name="focusPursueBean" property="frontFor">
					<html:text property="frontFor" styleClass="writeTextStyle" size="35" styleId="frontFor"/>
				</logic:notEmpty>
				<logic:empty name="focusPursueBean" property="frontFor">
				...
				<td class="valueStyle" colspan="3">				
				<logic:notEmpty name="focusPursueBean" property="underTake">
					<html:text property="underTake" styleClass="writeTextStyle" size="35" styleId="underTake" />
				</logic:notEmpty>
				<logic:empty name="focusPursueBean" property="underTake">
			...
			<tr>
				...
				<td class="valueStyle">				
				<logic:notEmpty name="focusPursueBean" property="supportTel">
					<html:text property="supportTel" styleClass="writeTextStyle" styleId="supportTel"/>
				</logic:notEmpty>
				<logic:empty name="focusPursueBean" property="supportTel">
				...
				<td class="valueStyle">				
				<logic:notEmpty name="focusPursueBean" property="supportSite">
					<html:text property="supportSite" styleClass="writeTextStyle" styleId="supportSite"/>
				</logic:notEmpty>
				<logic:empty name="focusPursueBean" property="supportSite">
				...
				<td class="valueStyle" colspan="3">				
				<logic:notEmpty name="focusPursueBean" property="contactMail">
					<html:text property="contactMail" styleClass="writeTextStyle" styleId="contactMail"/>
				</logic:notEmpty>
				<logic:empty name="focusPursueBean" property="contactMail">
			...
			<tr>
				...
				<td class="valueStyle">
				<logic:notEmpty name="focusPursueBean" property="chiefEditor">
					<html:text property="chiefEditor" styleClass="writeTextStyle" styleId="chiefEditor"/>
				</logic:notEmpty>
				<logic:empty name="focusPursueBean" property="chiefEditor">
				...
				<td class="valueStyle">
				<logic:notEmpty name="focusPursueBean" property="subEditor">
					<html:text property="subEditor" styleClass="writeTextStyle" styleId="subEditor"/>
				</logic:notEmpty>
				<logic:empty name="focusPursueBean" property="subEditor">
				...
				<td class="valueStyle">
				<logic:notEmpty name="focusPursueBean" property="firstEditor">
					<html:text property="firstEditor" styleClass="writeTextStyle" styleId="firstEditor"/>
				</logic:notEmpty>
				<logic:empty name="focusPursueBean" property="firstEditor">
			...
			<tr>
				...
				<td class="valueStyle">
					...
					<img alt="选择时间" src="../html/img/cal.gif" onclick="openCal('focusPursueBean','createTime',false);">
...
<%--					<logic:empty name="focusPursueBean" property="dictProductType">--%>
<%--						<select name="dictProductType" class="selectStyle">--%>
<%--								<OPTION value="">请选择名称</OPTION>--%>
<%--						</select>--%>
<%--					</logic:empty>--%>
<%--					<logic:notEmpty name="focusPursueBean" property="dictProductType">--%>
...
<%--					</span>--%>
				...
				<td class="valueStyle">
					<html:select property="dictFocusType" styleClass="selectStyle" styleId="dictFocusType">
						<html:option value="">请选择</html:option>
						<html:option value="实事版">实事版</html:option>
						<html:option value="市场版">市场版</html:option>
					</html:select>
					<span id="dictFocusTypeTip" style="width: 0px;display:inline;"></span>
				</td>
				<td class="labelStyle">
					审核状态
				</td>
				<td class="valueStyle">
<%--					<jsp:include flush="true" page="../flow/incState.jsp?form=focusPursueBean"/>--%>
				<logic:equal name="opertype" value="insert">
				<jsp:include flush="true" page="../flow/incState.jsp?form=focusPursueBean&opertype=insert"/>
				</logic:equal>
				<logic:equal name="opertype" value="detail">
				<jsp:include flush="true" page="../flow/incState.jsp?form=focusPursueBean&opertype=detail"/>
				</logic:equal>
				<logic:equal name="opertype" value="update">
				<jsp:include flush="true" page="../flow/incState.jsp?form=focusPursueBean&opertype=update"/>
				</logic:equal>
				<logic:equal name="opertype" value="delete">
				<jsp:include flush="true" page="../flow/incState.jsp?form=focusPursueBean&opertype=delete"/>
				</logic:equal>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="valueStyle" colspan="4">
					<html:text property="chiefTitle" styleClass="writeTextStyle" size="44" styleId="chiefTitle" />
				...
				<td class="valueStyle" colspan="3">
					<html:text property="subTitle" styleClass="writeTextStyle" size="35" />
				</td>
			</tr>
			<tr>
				<td class="labelStyle">
			...
			<tr>
				...
				<td colspan="8">
					<FCK:editor instanceName="fucosContent" >
						<jsp:attribute name="value"><bean:write name="focusPursueBean" property="fucosContent" filter="false"/></jsp:attribute>
					</FCK:editor>
					<span id="fucosContentTip" style="width: 0px;display:inline;"></span>
				</td>
			</tr>
			<tr>
				<td class="labelStyle">
				...
				<td class="valueStyle" colspan="5">
					<html:textarea property="leadInstruction"
						styleClass="writeTextStyle" rows="2" cols="80" />
				</td>
				...
				<td class="labelStyle" rowspan="4" colspan="2" width="180" style="text-indent: 0px;">
					<logic:equal name="opertype" value="insert">
...
<%--					</logic:equal>--%>
	...
	<%
	String id = (String) ((excellence.framework.base.dto.IBaseDTO) request.getAttribute("focusPursueBean")).get("focusId");
	String p = "../upload/show.jsp?t=oper_focusinfo.focus_id&id=" + id;
	%>
	...
	function processResponse1() {
    	if (XMLHttpReq.readyState == 4) { // 判断对象状态
        	if (XMLHttpReq.status == 200) { // 信息已经成功返回，开始处理信息
                ...
                document.getElementById("product_name_span").innerHTML = "<select name='dictProductType' class='selectStyle'><OPTION  value=''>请选择名称</OPTION></select>";
            } else { //页面不正常
                window.alert("您所请求的页面有异常。");
            }
        }

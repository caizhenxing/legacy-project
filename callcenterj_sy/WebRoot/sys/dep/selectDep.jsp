...
<%--	后添加的做查找用的  --%>
	  ...
	  function checkForm(addstaffer){  	
        	...
        	if (!checkNotNull(addstaffer.userTwo,"人员")) return false;
...
<%--            }--%>
	  ...
	  function getvalue(oToList){
    	 ...
    	 if(checkForm(f)){
		    document.forms[0].action = "../user/UserOper.do?method=operUserAll&str="+str;
	        document.forms[0].submit();
        }
...
<body onunload="toback()">
	...
	<logic:equal name="userReg" value="yes">
	<script>
		alert("该用户已是OA用户了,请重新选择");
	</script>
	</logic:equal>
	
	<html:form action="/sys/department/deptTree.do" method="post">
		<input type="hidden" name="ll"/>
	
		<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
			<tr>
				<td colspan="4" align="center">姓名查询:<input type="text" name="selectName"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" onclick="userselect()" value="查询"/> <br></td>
			</tr>
			<tr>
				<td align="center" colspan="4">
					<font color="#ff0000" size="2">选到右文本域的将统一被添加为OA用户,并且密码默认被设置为123456</font>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="tdbgcolorloadleft" >
						...
						<p align="center">
							<input type="button" value="&lt;&lt;" class="button"  onClick="javascript:suball()" />
						</p>
						<p align="center">
							<input type="button" value="&lt;-" class="button"  onClick="javascript:sub(userTwo)" />
						</p>
						<p align="center">
							<input type="button" value="-&gt;" class="button"  onClick="javascript:add1(userFirst)" />
						</p>
						<p align="center">
							<input type="button" value="&gt;&gt;" class="button"  onClick="javascript:addall()" />
						</p>

...
<html:html lang="true">
  <head>
    ...
    <title>paramTreeDtladd.jsp</title>
	...
	<script language="javascript">
		function execModify()
		{
			document.getElementById("treeForm").action = "./../parameter/paramTree.do?method=operParamTree&operType=update";
  ...
  <body>
    <html:form styleId="treeForm" action="/sys/parameter/paramTree.do?method=operParamTree&operType=insert">
    <table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
  <tr>
    <td  class="tdbgcolorloadright">参数名<br></td>
   ...
   <tr>
    <td  class="tdbgcolorloadright">上级参数<br></td>
    <td  class="tdbgcolorloadleft">

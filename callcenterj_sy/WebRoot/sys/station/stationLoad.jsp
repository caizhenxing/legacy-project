    ...
    <html:form action="/sys/station/station.do" method="post">
		<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  ...
		  <tr>
		    ...
		    <td class="tdbgcolorloadleft">
		    <html:text property="deppersonname" styleClass="input"/><font color="#ff0000">*</font>
		    </td>
		  </tr>
		  <tr>
		    <td class="tdbgcolorloadright"><bean:message bundle="sys" key="sys.station.stationload.depperson"/></td>
		    <td class="tdbgcolorloadleft">
		    <html:textarea property="deplevel" styleClass="input" rows="5" cols="50"/><font color="#ff0000">*</font>
		    </td>
		  </tr>
		  <tr>
		  ...
		  <tr>
		    ...
		    <logic:equal name="opertype" value="delete">
		     <input name="btnDel" type="button" class="button" value="<bean:message bundle='sys' key='sys.delete'/>" onclick="del()"/>
		    </logic:equal>
		    <logic:equal name="opertype" value="update">
		     <input name="btnUpdate" type="button" class="button" value="<bean:message bundle='sys' key='sys.update'/>" onclick="update()"/>&nbsp;&nbsp;
		    </logic:equal>
		    <logic:equal name="opertype" value="insert">
		     <input name="btnAdd" type="button" class="button" value="<bean:message bundle='sys' key='sys.insert'/>" onclick="add()"/>&nbsp;&nbsp;
		    </logic:equal>
		    <input name="btnReset" type="button" class="button" value="<bean:message bundle='sys' key='sys.cancel'/>" onclick="javascript:window.close();"/></td>

		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td class="labelStyle" align="left">
					<input type="radio" name="callType" value="out" onclick="checks()" checked> 外呼<input type="radio" name="callType" value="in" onclick="checks()" > 内呼 &nbsp;<input type="button" value="呼叫" onclick="execCall()"/>&nbsp;<input type="button" value="挂断" onclick="execHook()"/>&nbsp;<input type="button" value="关闭" onclick="window.close()" />
				</td>
			</tr>
			<tr>

...
<%-- 		document.forms[0].submit();--%>
		...
		popUp(num,'operCorpinfo.do?method=toStatisticForwardAction&statisticType='+type,800,460);
				...
				<td class="LabelStyle">
					...
					<td class="valueStyle">
						<html:select property="statisticType" styleClass="selectStyle">
							...
							<html:option value="ByType">信息类型量统计</html:option>

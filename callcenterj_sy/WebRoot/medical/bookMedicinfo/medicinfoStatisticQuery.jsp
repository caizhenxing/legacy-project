...
<%-- 		document.forms[0].submit();--%>
		...
		popUp(num,'bookMedicinfo.do?method=toStatisticForwardAction&statisticType='+type,800,460);
				...
				<td class="LabelStyle">
					...
					<td class="valueStyle">
						<html:select property="statisticType" styleClass="selectStyle">
							<html:option value="BySeat">座席受理量统计</html:option>
							<html:option value="ByExpert">专家受理量统计</html:option>
							<html:option value="ByState">座席审核量统计</html:option>
							<html:option value="ByParter">新农合数量统计</html:option>
							<html:option value="ByUser">用户咨询量统计</html:option>
							<html:option value="ForService">医服类型量统计</html:option>
							<html:option value="ForVisit">是否就诊量统计</html:option>
							<html:option value="ForNavigator">导诊量统计</html:option>
						</html:select>
					</td>

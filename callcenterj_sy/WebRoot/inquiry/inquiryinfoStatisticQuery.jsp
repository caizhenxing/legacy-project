...
<%-- 		document.forms[0].submit();--%>
		...
		popUp(num,'inquiry.do?method=toStatisticForwardAction&statisticType='+type,800,460);
				...
				<td class="LabelStyle">
					...
					<td class="valueStyle">
						<html:select property="statisticType" styleClass="selectStyle">
							<html:option value="ByType">类别调查量统计</html:option>
							<html:option value="ByOrganization">机构调查量统计</html:option>
							<html:option value="Byorganizers">组织调查量统计</html:option>
							<%--<html:option value="ByType">全部评别和各评别产品数量统计</html:option>
							<html:option value="OneEditor">全部品种和各品种的产品数量统计</html:option>
							<html:option value="AllEditor">每一责任编辑各评别的产品数量统计</html:option>
							--%>
						</html:select>
					</td>

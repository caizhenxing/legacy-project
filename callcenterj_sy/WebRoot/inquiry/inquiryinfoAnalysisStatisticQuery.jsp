...
<%-- 		document.forms[0].submit();--%>
		...
		popUp(num,'inquiryResult.do?method=toStatisticForwardAction&statisticType='+type,800,460);
...
<body class="conditionBody">
	<html:form action="/inquiryResult" method="post">
	
		<table width="100%" border="0" align="center" cellpadding="0"
			cellspacing="1" class="conditionTable">
			<tr>
				<td class="navigateStyle">
					当前位置->调查问卷分析库信息统计类型选择
				</td>
			</tr>
		</table>
				...
				<td class="LabelStyle">
					...
					<td class="valueStyle">
						<html:select property="statisticType" styleClass="selectStyle">
							<html:option value="BySeat">座席调查量统计</html:option>
							<html:option value="ByQuestion">问题回答量统计</html:option>
							<%--<html:option value="ByAnswer">问题答案量统计</html:option>--%>
						</html:select>
					</td>

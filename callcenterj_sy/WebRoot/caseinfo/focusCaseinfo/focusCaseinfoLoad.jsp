...
<%--    	    		if(checkForm(f)){--%>
<%--			 		document.forms[0].action="../focusCaseinfo.do?method=toFocusCaseinfo&type=insert";--%>
<%--			 		--%>
...
<%--					var f =document.forms[0];--%>
<%--    	    		if(checkForm(f)){--%>
<%--			 		document.forms[0].action="../focusCaseinfo.do?method=toFocusCaseinfo&type=update";--%>
<%--			 	--%>
<%--			 		document.forms[0].submit();--%>
<%--			 		}--%>
<%--				}--%>
<%--				function del()--%>
<%--				{--%>
<%--			 		document.forms[0].action="../focusCaseinfo.do?method=toFocusCaseinfo&type=delete";--%>
<%--			 		--%>
<%--			 		document.forms[0].submit();--%>
<%--				}--%>
		...
		<c:choose>				
			...
			$.formValidator.initConfig({formid:"focusCaseId",onerror:function(msg){alert(msg)}});
			...
			$("#caseAttr4").formValidator({empty:false,onshow:"请选择案例属性",onfocus:"案例属性必须选择",oncorrect:"OK!"}).inputValidator({empty:false,min:1,onerror: "没有选择案例属性"});			
...
<body onunload="toback()" class="loadBody" onload="init()">
	...
	<html:form action="/caseinfo/focusCaseinfo.do" method="post" styleId="focusCaseId">
...
<%--				</td>--%>
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="contentTable">
			<tr>
				<td class="labelStyle" nowrap>
					受理工号
				</td>
				<td class="valueStyle" width="255">
				...
				<td class="labelStyle" width="70" nowrap>
					受理专家
				</td>
...
<%--					<html:text property="caseExpert" styleClass="writeTextStyle"/>--%>
			...
			<tr>
				...
				<td class="valueStyle">
				<logic:equal name="opertype" value="insert">
				<jsp:include flush="true" page="../../flow/incState.jsp?form=focusCaseinfoBean&opertype=insert"/>
				</logic:equal>
				<logic:equal name="opertype" value="detail">
				<jsp:include flush="true" page="../../flow/incState.jsp?form=focusCaseinfoBean&opertype=detail"/>
				</logic:equal>
				<logic:equal name="opertype" value="update">
				<jsp:include flush="true" page="../../flow/incState.jsp?form=focusCaseinfoBean&opertype=update"/>
				</logic:equal>
				<logic:equal name="opertype" value="delete">
				<jsp:include flush="true" page="../../flow/incState.jsp?form=focusCaseinfoBean&opertype=delete"/>
				</logic:equal>					
<%--					<jsp:include flush="true" page="../../flow/incState.jsp?form=focusCaseinfoBean"/>--%>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="valueStyle" colspan="3">
					<html:text property="custAddr" size="70" styleClass="writeTextStyle" />
					<input type="button" name="btnadd" class="buttonStyle" value="选择"
						onClick="window.open('focusCaseinfo/select_address.jsp','','width=500,height=140,status=no,resizable=yes,scrollbars=yes,top=200,left=400')" />
				</td>
				...
				<td class="valueStyle">
					...
					<html:hidden property="dictCaseType" value="FocusCase" />
			...
			<tr>
				...
				<td class="valueStyle">
					<html:select property="caseAttr4" styleClass="selectStyle" style="width:130px" styleId="caseAttr4">
					...
					<div id="caseAttr4Tip" style="width:0px;display:inline;"></div>
				</td>
				<td class="labelStyle">
					热线调查
				</td>
				<td class="valueStyle">
					<html:text property="caseInquiry" styleClass="writeTextStyle" />
				</td>
				<td class="valueStyle">&nbsp;
				</td>
				<td class="valueStyle">&nbsp;
			...
			<tr>
				...
				<td class="valueStyle" colspan="3">
					<html:textarea property="caseContent" styleClass="writeTextStyle" cols="75" rows="4"  styleId="caseContent"/>
						<div id="caseContentTip" style="width:0px;display:inline;"></div>
				</td>
				<td class="labelStyle" rowspan="2" colspan="2" style="text-indent: 0px;">
					<logic:equal name="opertype" value="insert">
...
<%--					<iframe frameborder="0" width="100%" scrolling="No" src="../../upload/up2.jsp" allowTransparency="true"></iframe>--%>
			...
			<tr>
				...
				<td class="valueStyle" colspan="3">
					<html:textarea property="caseReply" styleClass="writeTextStyle" cols="75" rows="4" styleId="caseReply"/>
			...
			<tr>
				...
				<td class="valueStyle" colspan="3">
					<html:textarea property="caseReview" styleClass="writeTextStyle" cols="75" rows="4" styleId="caseReview"/>
					<div id="caseReviewTip" style="width:0px;display:inline;"></div>
				</td>
				
					<%
						String id = (String) ((excellence.framework.base.dto.IBaseDTO) request.getAttribute("focusCaseinfoBean")).get("caseId");
			...
			<tr>
				...
				<td class="valueStyle" colspan="3">
					<html:textarea property="remark" styleClass="writeTextStyle" cols="75" rows="4" />
				</td>
			</tr>
...
<%--					</logic:equal>--%>
<%--					<logic:equal name="opertype" value="update">--%>
<%--						<input type="button" name="btnUpdate" value="确定" class="buttonStyle"--%>
<%--							onclick="update()" />--%>
<%--					</logic:equal>--%>
<%--					<logic:equal name="opertype" value="delete">--%>

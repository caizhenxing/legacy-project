...
<%-- 		document.forms[0].submit();--%>
		...
		popUp(num,'focusCaseinfo.do?method=toStatisticForwardAction&statisticType='+type,800,460);
				...
				<td class="LabelStyle">
					...
					<td class="valueStyle">
						<html:select property="statisticType" styleClass="selectStyle">
							...
							<html:option value="oneOrAll">座席审核量统计</html:option>

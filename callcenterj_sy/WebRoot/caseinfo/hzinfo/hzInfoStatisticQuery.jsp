...
<%-- 		document.forms[0].submit();--%>
		...
		popUp(num,'hzinfo.do?method=toStatisticForwardAction&statisticType='+type,800,460);
				...
				<td class="LabelStyle">
					...
					<td class="valueStyle">
						<html:select property="statisticType" styleClass="selectStyle">
							<html:option value="case">座席受理量统计</html:option>
							<html:option value="all">座席审核量统计</html:option>
							<html:option value="agent">案例属性量统计</html:option>
							<html:option value="expert">专家受理量统计</html:option>
						</html:select>
					</td>

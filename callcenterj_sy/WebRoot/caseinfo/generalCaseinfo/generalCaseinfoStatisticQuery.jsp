...
<%-- 		document.forms[0].submit();--%>
		popUp(num,'generalCaseinfo.do?method=toStatisticForwardAction&statisticType='+type,750,460);
			...
			<tr>
				...
				<td class="valueStyle">
					<html:select property="statisticType" styleClass="selectStyle">
						...
						<html:option value="case">案例属性量统计</html:option>
						<html:option value="StatisticsByExpert">专家受理量统计</html:option>
					</html:select>
				</td>

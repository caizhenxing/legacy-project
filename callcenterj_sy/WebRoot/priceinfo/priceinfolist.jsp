	...
	<table width="100%" align="center" cellpadding="0" cellspacing="1" class="listTable">
		...
		<logic:iterate id="c" name="list" indexId="i">
			...
			<tr style="line-height: 21px;">
				...
				<td>
					<bean:write name="c" property="productPrice" filter="true" />
				</td>
				<td>
				...
				<td>
					<bean:write name="c" property="priceRid" filter="true" />
				</td>
				<td>
					<img alt="详细" src="../style/<%=styleLocation%>/images/detail.gif"
						onclick="popUp('1<bean:write name='c' property='priceId'/>','operpriceinfo.do?method=toOperPriceinfoLoad&type=detail&id=<bean:write name='c' property='priceId'/>',720,260)"
		...
		<tr style="line-height: 21px;">
			...
			%>		
				<input type="button" name="btnadd" value="添加" class="buttonStyle" onclick="popUp('operpriceinfoWindows','operpriceinfo.do?method=toOperPriceinfoLoad&type=insertList',860,312)"/>
			</td>
		</tr>
		<tr>
			<td colspan="8">

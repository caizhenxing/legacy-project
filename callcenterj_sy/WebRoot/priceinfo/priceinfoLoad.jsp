...
<body onunload="toback()" class="loadBody" onload="init()" >
	...
	<html:form action="/operpriceinfo.do" method="post" styleId="formValidate" >
...
<%--					<font color="#ff0000">*</font>--%>
				...
				<td class="valueStyle">
				<logic:equal name="opertype" value="insert">
				<jsp:include flush="true" page="../flow/incState.jsp?form=priceinfoBean&opertype=insert"/>
				</logic:equal>
				<logic:equal name="opertype" value="detail">
				<jsp:include flush="true" page="../flow/incState.jsp?form=priceinfoBean&opertype=detail"/>
				</logic:equal>
				<logic:equal name="opertype" value="update">
				<jsp:include flush="true" page="../flow/incState.jsp?form=priceinfoBean&opertype=update"/>
				</logic:equal>
				<logic:equal name="opertype" value="delete">
				<jsp:include flush="true" page="../flow/incState.jsp?form=priceinfoBean&opertype=delete"/>
				</logic:equal>
...
<%--					<span id="custNameTip" style="width: 10px;display:inline;"></span>--%>
			...
			<tr>
				...
				<td class="valueStyle">
				<%
				String dpt = (String)((excellence.framework.base.dto.IBaseDTO)request.getAttribute("priceinfoBean")).get("dictProductType1");
				%>

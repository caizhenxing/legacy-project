...
function calendar3(obj_target,event) {
	// assigning methods
...
function cal_popup3 (str_datetime) {
	...
	var obj_calwindow = window.open(
		'/callcenterj_sy/html/calendar.html?id=' + this.id + '&s=' + this.dt_selected.valueOf() + '&c=' + this.dt_current.valueOf(),
		'Calendar', 'width=200,height=' + (this.time_comp ? 215 : 190) +
		',status=no,resizable=no,top='+theY+',left='+theX+',dependent=yes,alwaysRaised=yes'
	);
...
function openCal(formName,elementName,isTime){
	var cal=new calendar3(document.forms[formName].elements[elementName],window.event);
	cal.time_comp = isTime;
	cal.popup();
}
...
//查询页日期相同处理 js处理存在问题
function setSameDateTime(oBTime,oETime)
{

//	if(typeof(oBTime) == "undefined"||typeof(oETime) == "undefined")
//	{
//		return;
//	}
//	var bTime = oBTime.value;
//	var eTime = oETime.value;
//	if(bTime==''||eTime=='')
//	{
//		return;
//	}
//	if(bTime==eTime)
//	{
//		oBTime.value = bTime+' 00:00:00';
//		oETime.value = bTime+' 23:59:59';
//	}
}

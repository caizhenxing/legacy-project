...
<%-- 		document.forms[0].submit();--%>
		...
		popUp(num,'sad.do?method=toStatisticForwardAction&statisticType='+type,800,460);
				...
				<td class="LabelStyle">
					...
					<td class="valueStyle">
						<html:select property="statisticType" styleClass="selectStyle">
							<html:option value="proc_productPriceStatisticsBySeat">座席受理量统计</html:option>
							<html:option value="StatisticsByState">座席审核量统计</html:option>
							<html:option value="proc_sadStatisticsByType">供求类型量统计</html:option>
							<html:option value="proc_sadStatisticsByProduct">产品供求量统计</html:option>
						</html:select>
					</td>

  ...
  <body class="listBody">
    <html:form action="custinfo/custinfo.do"  method="post">
		<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" class="listTable">
		  <tr>
		    <td class="listTitleStyle" width="15%">姓名</td>
		    <td class="listTitleStyle" width="15%">宅电</td>
		    <td class="listTitleStyle" width="15%">手机</td>
		    <td class="listTitleStyle" width="15%">办公电话</td>
		    <td class="listTitleStyle" width="10%">客户行业</td>
		    <td class="listTitleStyle" width="15%">客户类型</td>
		    <td class="listTitleStyle" width="10%">选择</td>
		  </tr>

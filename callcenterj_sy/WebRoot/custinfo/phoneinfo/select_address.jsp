		...
		<form name="address" method="post" action="">
			<table width="450" border="0" align="center">
				...
				<tr>
					...
					<td id="sectiontd" class="writeTextStyle">
						<select name="section" id="section" class="writeTextStyle">
							<option>
								请选择区/县
							</option>
						</select>
					</td>
					<td id="villagestd" class="writeTextStyle">
						<select name="villages" id="villages" class="writeTextStyle">
							<option>
								请选择乡/镇
							</option>
						</select>
					</td>
					<td id="communitytd" class="writeTextStyle">
						<select name="community" id="community" class="writeTextStyle">
							<option>
								请选择社区/村
							</option>
						</select>

...
<html>
  ...
  <frameset name="dict" rows="15%,*" border="0" frameborder="0"  framespacing="0">
  	<frame name="topp" scrolling="no" src="phoneinfo.do?method=toPhoneQuery" noresize>
	<frame name="bottomm" scrolling="no" src="phoneinfo.do?method=toPhoneList" noresize>
  </frameset>
</html>

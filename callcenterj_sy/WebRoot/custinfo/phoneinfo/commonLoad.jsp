...
<%--		    	</logic:equal>--%>
			...
			<table width="100%" border="0" align="center" cellpadding="1"
				...
				<tr>
					...
					<td class="valueStyle" >
						<html:text property="cust_age" styleClass="writeTypeStyle" size="4" styleId="cust_age"/>
				...
				<tr>
					...
					<td class="valueStyle">
						<html:select property="cust_way_by" styleClass="writeTypeStyle" >
...
<%--							size="13" />--%>
					...
					<td class="valueStyle">
						<html:select property="dict_cust_scale" styleClass="writeTypeStyle" >
				...
				<tr>
					...
					<td class="valueStyle">
						<html:text property="cust_tel_home" size="13" styleClass="writeTypeStyle" size="13" styleId="cust_tel_home"/>
				...
				<tr>
					...
					<td class="valueStyle">
						<html:text property="cust_pcode" styleClass="writeTypeStyle" />
					</td>
				</tr>
				<tr>
					<td class="labelStyle">
					...
					<td class="valueStyle">
						<html:text property="cust_email" styleClass="writeTypeStyle" size="15" styleId="cust_email"/>
				...
				<tr>
					...
					<td class="valueStyle">
						<html:textarea property="cust_intru" rows="5" cols="30"
							styleClass="writeTypeStyle" />
					</td>
					<td class="labelStyle">
						用户备注

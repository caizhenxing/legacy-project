	...
	if(table !=null && !table.equals("") && id !=null && !id.equals("")){
		try {
			...
			if(rs.next()){
				...
				out.println("<table width='100%' class='valueStyle'>");
				out.println("<tr>");
				for(int i = 0; i<imgs.length; i++){
					...
					String outStr = "<td><a href=\""+ basePath +"UploadFile/"+name[1]+"\" target=\"_blank\"><img width=\"90\" height=\"77\" src=\""+src+"\" border=\"0\"></a>";
					if(operType!=null&&operType.equals("update")){
						outStr += "<br>"+name[0]+"[<a href=\""+ basePath +"upload/del.jsp?t="+ t +"&id="+ id +"&i="+ i +"\">删除</a>]</td>";
					}
					if(i % 5 == 4){	//换行显示
						outStr = "</tr><tr>" + outStr;
					}

...
function insertIt(){
  ...
  <tr>
    ...
    <img alt="<bean:message key='sys.insert'/>" src="<bean:write name='imagesinsession'/>sysoper/add.gif" onclick="window.open('dep.do?method=load&type=insert&parentId=<bean:write name='DepInfo' property='id'/>','windows','480.400,scrollbars=yes')" width="16" height="16" target="windows" border="0"/>
    ...
    <img alt="<bean:message key='sys.delete'/>" src="<bean:write name='imagesinsession'/>sysoper/del.gif" onclick="window.open('dep.do?method=todelete&id=<bean:write name='DepInfo' property='id'/>','windows','480.400,scrollbars=yes')" width="16" height="16" target="windows" border="0"/>

...
<html>
  <head>
    ...
    <script language="javascript">
        function checkForm(addstaffer){
            if (!checkNotNull(addstaffer.password,"¾ÉÃÜÂë")) return false;
            if (!checkNotNull(addstaffer.repassword,"ĞÂÃÜÂë")) return false;
            if (!checkNotNull(addstaffer.repasswordAffirm,"È·ÈÏÃÜÂë")) return false;
              return true;
            }
        //ĞŞ¸Ä
    	function update(){
  ...
  <body bgcolor="#eeeeee">
    <logic:notEmpty name="operSign">
	  <script>alert("<bean:message name='operSign'/>");</script>
	</logic:notEmpty>
<%--	<logic:notEmpty name="operSign">--%>
<%--	<%--%>

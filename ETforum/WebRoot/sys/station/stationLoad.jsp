    ...
    <html:form action="/sys/station/station.do" method="post">
		<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  ...
		  <tr>
		    ...
		    <bean:message key="sys.station.stationload.operator"/>
		    </td>
		  </tr>
		  <tr>
		    <td class="tdbgcolorloadright"><bean:message key="sys.station.stationload.seldep"/></td>
		    <td class="tdbgcolorloadleft">
			    <html:select property="departmentid">		
	        	<html:option value="" ><bean:message key="sys.station.stationload.pleaseselect"/></html:option>
	        		<html:optionsCollection name="ctreelist" label="label" value="value"/>
	        	</html:select>
		    </td>
		  </tr>
		  <tr>
		    <td class="tdbgcolorloadright"><bean:message key="sys.station.stationload.depname"/></td>
		    <td class="tdbgcolorloadleft">
		    <html:text property="deppersonname" styleClass="input"/>
		    </td>
		  </tr>
		  <tr>
		    <td class="tdbgcolorloadright"><bean:message key="sys.station.stationload.depperson"/></td>
		    <td class="tdbgcolorloadleft">
		    <html:textarea property="deplevel" styleClass="input" rows="5" cols="50"/>
		    </td>
		  </tr>
		  <tr>
		    <td class="tdbgcolorloadright"><bean:message key="sys.station.stationload.depdescribe"/></td>
		    <td class="tdbgcolorloadleft">

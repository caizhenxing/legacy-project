...
<%--        </table>--%>
		...
		<a href="../forumList.do?method=toAnswerPostList&itemid=<bean:write name='c' property='itemId'/>&postid=<bean:write name='c' property='id'/>">
		<span class="bold"><bean:write name="c" property="title" filter="true"/></span>
		</a>
<%--		<span class="todayposts"></span>--%>
		<br><span class="smalltxt"></span></td>
		<td class=tdbgcolorlist2 align="center">
		...
		<tr>
				    <td colspan="5">
						<page:page name="mySendPostpageTurning" style="first"/>				    </td>
		  </tr>
		</table>
  </html:form>
  </body>

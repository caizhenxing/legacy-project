  ...
  <head>
    ...
    <script language="javascript">
    	...
    	function sendPost(){
    		...
    		if(checkForm(f)){
    		document.forms[0].action = "oper.do?method=sendPosts&itemid=<bean:write name='itemid'/>";
	 ...
	 <table width="916" border="1" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td class="danzhi">&nbsp; 文章描述： </td>
                <td>
                <html:text property="titledescribe"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>&nbsp;</td>
                <td>&nbsp;&nbsp; <label>
                  <input type="button" name="sendpost" value="发表" onclick="sendPost()">
                  &nbsp; 
            ...
            <tr>
              <td colspan="2" background="images/di.jpg">&nbsp;</td>
              </tr>
          </table>

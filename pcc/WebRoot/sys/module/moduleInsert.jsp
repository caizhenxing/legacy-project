...
<html:html  locale="true">
  <head>
    ...
    <title><bean:message key="sys.module.title.insert"/></title>
...
function insertIt(){
		alert("");
		popUp('windows','/callcenter/sys/module.do?method=load&type=insert',480,400);
	}
	...
	function deleteIt()
	{
		...
		document.forms[0].action = '/callcenter/sys/module.do?method=delete';
  ...
  <body>
  <html:form action="/sys/module.do?method=insert">
    <table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#d8d8e5">
  <tr>
    <td colspan="2" class="tdbgpicload"><bean:message key="sys.module.title.insert"/></td>
  </tr>
  ...
  <tr>
    ...
    <html:submit><bean:message key="sys.insert"/></html:submit>
     </td>
  </tr>
</table>
</html:form>

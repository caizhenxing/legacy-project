...
function insertIt(){
  ...
  <body>
  <html:form action="/sys/module.do?method=update">
<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
  ...
  <tr>
    ...
    <html:link action="/sys/module.do?method=load&type=insert" paramId="parentId" paramName="ModInfo" paramProperty="id" onclick="popUp('windows','',480,400)" target="windows" ><bean:message key="sys.insert"/>
    </html:link>
    <a  href="javascript:updateIt()" ><bean:message key="sys.update"/></a>
    
    <html:link action="/sys/module.do?method=delete" paramId="id" paramName="ModInfo" paramProperty="id" onclick="deleteIt()" target="contents" ><bean:message key="sys.delete"/>
	</html:link>
</td>
  </tr>
</table>

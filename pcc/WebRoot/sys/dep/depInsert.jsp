...
<html:html  locale="true">
  <head>
    ...
    <title><bean:message key="sys.dep.title.insert"/></title>
...
function insertIt(){
		alert("");
		popUp('windows','/callcenter/sys/dep.do?method=load&type=insert',480,400);
	}
	...
	function deleteIt()
	{
		...
		document.forms[0].action = '/callcenter/sys/dep.do?method=delete';
  ...
  <body>
  <html:form action="/sys/dep.do?method=insert">
    <table width="40%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
  <tr>
    <td colspan="2" class="tdbgpicload"><bean:message key="sys.dep.title.insert"/></td>
  </tr>

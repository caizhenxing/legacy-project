...
function insertIt(){
  ...
  <tr>
    ...
    <html:link action="/sys/tree.do?method=load&type=insert" paramId="parentId" paramName="TreeInfo" paramProperty="id" onclick="popUp('windows','',480,400)" target="windows" ><bean:message key="sys.insert"/>
    </html:link>
    <a  href="javascript:updateIt()" ><bean:message key="sys.update"/></a>
    
    <html:link action="/sys/tree.do?method=delete" paramId="id" paramName="TreeInfo" paramProperty="id" onclick="deleteIt()" target="contents" ><bean:message key="sys.delete"/>
	</html:link>
</td>
  </tr>
</table>

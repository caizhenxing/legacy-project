...
<html:html locale="true">
  <head>
    ...
    <script language="javascript">
    	...
    	//≤È—Ø
    	function query(){
    		document.forms[0].action = "../opernews.do?method=toArticleList";
    ...
    <html:form action="/news/opernews.do" method="post">
		<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
		    ...
		    <bean:message key="agrofront.news.article.articlequery.title"/>
		    </td>
		  </tr>
		</table>
		<table width="70%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  <tr>
		    <td class="tdbgcolorqueryright"><bean:message key="agrofront.news.article.articlequery.articletitle"/></td>
		    <td class="tdbgcolorqueryleft">
		    <html:text property="title" styleClass="input"/>
		    </td>
		    <td class="tdbgcolorqueryright"><bean:message key="agrofront.news.article.articlequery.author"/></td>
		    <td class="tdbgcolorqueryleft"><html:text property="author" styleClass="input"/></td>
		  </tr>
		  <tr>
        	...
        	<html:option value="">«Î—°‘Ò</html:option>
		  ...
		  <tr>
		    ...
		    <input name="btnAdd" type="button" class="bottom" value="<bean:message key='agrofront.common.insert'/>" onclick="window.open('opernews.do?method=toArticleLoad&type=insert','windows','750.700,scrollbars=yes')"/>
		    </td>
		  </tr>

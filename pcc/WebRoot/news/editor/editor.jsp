...
<div class="yToolbar"> 
  ...
  <div class="TBSep"></div>
  <div class="Btn" TITLE="剪切" LANGUAGE="javascript" onclick="format('cut')"> <img class="Ico" src="../css/img4edit/cut.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  ...
  <div class="Btn" TITLE="插入栏目框" LANGUAGE="javascript" onclick="FIELDSET()"> <img class="Ico" src="../css/img4edit/fieldset.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入网页" LANGUAGE="javascript" onclick="iframe()"> <img class="Ico" src="../css/img4edit/htm.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="插入图片" LANGUAGE="javascript" onclick="pic()"> <img class="Ico" src="../css/img4edit/img.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
<!--   <iframe class="TBGen" style="top:2px" ID="UploadFiles" src="#" frameborder=0 scrolling=no width="250" height="25"></iframe> -->
  ...
  <div class="Btn" TITLE="插入特殊水平线" LANGUAGE="javascript" onclick="hr()"> <img class="Ico" src="../css/img4edit/sline.gif" WIDTH="18" HEIGHT="18"> 
  </div>
</div>
...
<div class="yToolbar"> 
  ...
  <div class="Btn" TITLE="保存"	LANGUAGE="javascript" onclick="save()"> <img class="Ico" src="../css/img4edit/save.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="TBSep"></div>
<!--   <div class="Btn" TITLE="插入flash多媒体文件" LANGUAGE="javascript" onclick="swf()"> 
    <img class="Ico" src="../css/img4edit/flash.gif" WIDTH="18" HEIGHT="18"> </div>
  ...
  <div class="Btn" TITLE="插入RealPlay文件，支持格式为：rm、ra、ram" LANGUAGE="javascript" onclick="rm()"> 
    <img class="Ico" src="../css/img4edit/rm.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div> -->
  <div class="Btn" TITLE="查看帮助" LANGUAGE="javascript" onclick="help()"> <img class="Ico" src="../css/img4edit/help.gif" WIDTH="18" HEIGHT="18"> 
  </div>
  <div class="Btn" TITLE="简&rarr;繁" LANGUAGE="javascript" onclick="s2t();"><img class="Ico" src="../css/img4edit/st.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="Btn" TITLE="繁&rarr;简" LANGUAGE="javascript" onclick="t2s();"><img class="Ico" src="../css/img4edit/ts.gif" WIDTH="18" HEIGHT="18"> </div>
  <div class="TBSep"></div>
</div>
<div class="yToolbar"> 
  <div class="TBHandle"> </div>
  ...
  <div class="TBSep"></div>
  <div class="Btn" TITLE="字体颜色" LANGUAGE="javascript" onclick="foreColor()"> <img class="Ico" src="../css/img4edit/fgcolor.gif" WIDTH="18" HEIGHT="18"> 
  </div>

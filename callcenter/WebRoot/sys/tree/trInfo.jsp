...
<html:html  locale="true">
  <head>
    ...
    <title><bean:message key="sys.tree.title"/></title>
...
function insertIt(){
  ...
  <tr>
    <td colspan="2" class="tdbgpicload"><bean:message key="sys.tree.title"/></td>
  </tr>
  <tr>
   <td  class="tdbgcolorloadright"><bean:message key="sys.tree.id"/></td>
  ...
  <tr>
    ...
    <img alt="<bean:message key='sys.insert'/>" src="<bean:write name='imagesinsession'/>sysoper/add.gif" onclick="window.open('tree.do?method=load&type=insert&parentId=<bean:write name='TreeInfo' property='id'/>','windows','480.400,scrollbars=yes')" width="16" height="16" target="windows" border="0"/>
    ...
    <img alt="<bean:message key='sys.delete'/>" src="<bean:write name='imagesinsession'/>sysoper/del.gif" onclick="window.open('tree.do?method=todelete&id=<bean:write name='TreeInfo' property='id'/>','windows','480.400,scrollbars=yes')" width="16" height="16" target="windows" border="0"/>
</td>
  </tr>
</table>
</html:form>

    ...
    <html:form action="/sys/station/station.do" method="post">
		<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
		    ...
		    <bean:message key="sys.station.stationquery.depmanager"/>
		    </td>
		  </tr>
		</table>
		<table width="70%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  <tr>
		    <td class="tdbgcolorqueryright"><bean:message key="sys.station.stationquery.seldep"/></td>
		    <td class="tdbgcolorqueryleft">
		    <html:select property="departmentid">		
        	<html:option value="" ><bean:message key="sys.station.stationquery.pleaseselect"/></html:option>
		  ...
		  <tr>
		    <td class="tdbgcolorqueryright"><bean:message key="sys.station.stationquery.stationname"/></td>
		    <td class="tdbgcolorqueryleft"><html:text property="deppersonname" styleClass="input"/></td>
		    <td class="tdbgcolorqueryright"><bean:message key="sys.station.stationquery.stationperson"/></td>
		  ...
		  <tr>
		    ...
		    <input name="btnAdd" type="button" class="bottom" value="<bean:message key='agrofront.common.insert'/>" onclick="popUp('windows','station.do?method=toStationLoad&type=insert',650,350)"/>
		    </td>
		  </tr>
		</table>
    </html:form>

  ...
  <body bgcolor="#eeeeee">
    <html:form action="/pcc/operatorStatistic" method="post">
		<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  <tr>
		    <td class="tdbgpiclist"><bean:message bundle="pccye" key="et.pcc.operatorStatistic.operator"/></td>
		    <td class="tdbgpiclist"><bean:message bundle="pccye" key="et.pcc.operatorStatistic.signInNum"/></td>
		    <td class="tdbgpiclist"><bean:message bundle="pccye" key="et.pcc.operatorStatistic.settingNum"/></td>
		    <td class="tdbgpiclist"><bean:message bundle="pccye" key="et.pcc.operatorStatistic.answerPhoneNum"/></td>
...
<%--		    <td class="tdbgpiclist"><bean:message bundle="pccye" key="sys.common.detail"/></td>--%>
		  ...
		  <logic:iterate id="c" name="list" indexId="i">
			...
			%>
		  <tr>
		    <td class="<%=style%>"><bean:write name="c" property="operator" filter="true"/></td>
		    <td class="<%=style%>"><bean:write name="c" property="signIn" filter="true"/></td>
...
<%--		    </td>--%>
		  ...
		  <tr>
		    <td colspan="7">
				<page:page name="ospageTurning" style="first"/>
		    </td>
		  </tr>
		</table>
    </html:form>

...
<%--    <script language="JavaScript" src="../../js/calendar.js"></script>--%>
    <script language="javascript">
    	//²éÑ¯
    	function chuxiQuery(){
    		document.forms[0].action = "../operatorStatistic.do?method=toChuXiTimeList";
    		document.forms[0].target = "bottomm";
    		document.forms[0].submit();
    	}
    	function jieTingQuery(){
    		document.forms[0].action = "../operatorStatistic.do?method=toJieTingTimeList";
    		document.forms[0].target = "bottomm";
    		document.forms[0].submit();
    	}
    	function outQuery(){
    		document.forms[0].action = "../operatorStatistic.do?method=toOutTimeList";
    		document.forms[0].target = "bottomm";
    		document.forms[0].submit();
    	}
  ...
  <body bgcolor="#eeeeee">
    ...
    <html:form action="/pcc/operatorStatistic" method="post">
		  ...
		  <tr>
		    ...
		    <bean:message bundle="pccye" key="et.pcc.operatorStatistic.workTimeStatistic"/>
...
<%--		    <td class="tdbgcolorqueryleft"><html:text property="callinNumEnd" styleClass="input"/></td>--%>
		  ...
		  <tr>
		    ...
		    <td class="tdbgcolorqueryleft"><html:text property="beginTime" styleClass="input" />
		    ...
		    <td class="tdbgcolorqueryleft"><html:text property="endTime" styleClass="input" />
...
<%--		  </tr>--%>
		  <tr>
		    ...
		    <input name="btnSearch1" type="button" class="bottom" value="<bean:message bundle="pccye" key='et.pcc.operatorStatistic.list.chuxiTime'/>" onclick="chuxiQuery()"/>
		    <input name="btnSearch2" type="button" class="bottom" value="<bean:message bundle="pccye" key='et.pcc.operatorStatistic.list.jietingTime'/>" onclick="jieTingQuery()"/>
		    <input name="btnSearch3" type="button" class="bottom" value="<bean:message bundle="pccye" key='et.pcc.operatorStatistic.list.outTime'/>" onclick="outQuery()"/>

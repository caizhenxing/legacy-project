...
<html:html locale="true">
  <head>
    ...
    <script language="javascript">
    	...
    	function search(){
    	    ...
    	    if(checkForm(f)){
    		document.forms[0].action = "post.do?method=validInfo";
    	...
    	function update(){
    		var f =document.forms[0];
    	    if(checkFormPass(f)){
    		document.forms[0].action = "post.do?method=upInfo";
    		document.forms[0].submit();
    		}
    	}
  ...
  <body bgcolor="#eeeeee">
    ...
    <html:form action="/pcc/policeValid/post.do" method="post">
		<table width="100%" border="0" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  <tr>
		    <td colspan="2" class="tdbgpicload">第一步：输入以下四项信息验证用户身份。</td>
		  </tr>
		  <tr>

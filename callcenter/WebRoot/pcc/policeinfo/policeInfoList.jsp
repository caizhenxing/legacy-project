...
<html:html locale="true">
  <head>
    ...
    <script language="javascript">
		...
		function add(){
    	    ...
    	    if(checkForm(f)){
    		document.forms[0].action = "info.do?method=toAddPoliceInfo";
    		document.forms[0].submit();
    		}
		}
    </script>
  ...
  <body onload="clear()" bgcolor="#eeeeee">
    <html:form action="/pcc/policeinfo/info.do" method="post">

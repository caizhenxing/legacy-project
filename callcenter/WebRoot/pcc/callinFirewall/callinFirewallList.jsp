...
<html:html locale="true">
  ...
  <body bgcolor="#eeeeee">
    <html:form action="/pcc/callinFirewall" method="post">
		<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  <tr>
		    <td class="tdbgpiclist"><bean:message bundle="pccye" key="et.pcc.callinFirewall.phoneNum"/></td>
<%--		    <td class="tdbgpiclist">结束号段</td>--%>
<%--		    <td class="tdbgpiclist">开始时间</td>--%>
<%--		    <td class="tdbgpiclist">结束时间</td>--%>
		    <td class="tdbgpiclist"><bean:message bundle="pccye" key="et.pcc.callinFirewall.isPass"/></td>
		  ...
		  <logic:iterate id="c" name="list" indexId="i">
			...
			%>
		  <tr>
		    <td class="<%=style%>"><bean:write name="c" property="callinNumBegin" filter="true"/></td>
<%--		    <td class="<%=style%>"><bean:write name="c" property="callinNumEnd" filter="true"/></td>--%>
<%--		    <td class="<%=style%>"><bean:write name="c" property="beginTime" format="HH:mm" filter="true"/>--%>
...
<%--		    <a href="../callinFirewall.do?method=toCallinFireWallLoad&type=delete&id=<bean:write name='c' property='id'/>"><img alt="<bean:message bundle='pccye' key='sys.del'/>" src="<bean:write name='imagesinsession'/>sysoper/del.gif" width="16" height="16" border="0"  /></a>--%>
            <img alt="<bean:message key='sys.detail'/>" src="<bean:write name='imagesinsession'/>sysoper/particular.gif" onclick="window.open('callinFirewall.do?method=toCallinFireWallLoad&type=detail&id=<bean:write name='c' property='id'/>','windows','480.400,scrollbars=yes')" width="16" height="16" target="windows" border="0"/>
            <img alt="<bean:message key='sys.update'/>" src="<bean:write name='imagesinsession'/>sysoper/update.gif" onclick="window.open('callinFirewall.do?method=toCallinFireWallLoad&type=update&id=<bean:write name='c' property='id'/>','windows','480.400,scrollbars=yes')" width="16" height="16" target="windows" border="0"/>
		    <img alt="<bean:message key='sys.delete'/>" src="<bean:write name='imagesinsession'/>sysoper/del.gif" onclick="window.open('callinFirewall.do?method=toCallinFireWallLoad&type=delete&id=<bean:write name='c' property='id'/>','windows','480.400,scrollbars=yes')" width="16" height="16" target="windows" border="0"/>
<%--		    </logic:equal>--%>
...
<%--		    &nbsp;--%>
		  ...
		  <tr>
		    <td colspan="6">
				<page:page name="firewallpageTurning" style="first"/>
		    </td>
		  </tr>
		</table>
    </html:form>

  ...
  <head>
    ...
    <script language="javascript">
    	...
    	function checkForm(addstaffer){
            if (!checkNotNull(addstaffer.callinNumBegin,"<bean:message bundle='pccye' key='et.pcc.callinFirewall.phoneNum'/>")) return false;
            if (!checkNotNull(addstaffer.isPass,"<bean:message bundle='pccye' key='et.pcc.callinFirewall.isPass'/>")) return false;
  ...
  <body onunload="toback()"  bgcolor="#eeeeee">
    ...
    <html:form action="/pcc/callinFirewall" method="post">
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablebgcolor">
		  <tr>
		    ...
		    <logic:equal name="opertype" value="insert">
		     <bean:message bundle="pccye" key="et.pcc.callinFirewall.load.add"/>
		    </logic:equal>
		    <logic:equal name="opertype" value="update">
		     <bean:message bundle="pccye" key="et.pcc.callinFirewall.load.update"/>
		    </logic:equal>
		    <logic:equal name="opertype" value="delete">
		     <bean:message bundle="pccye" key="et.pcc.callinFirewall.load.delete"/>
		    </logic:equal>
		    </td>
		  </tr>
		</table>
		<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
          <tr>
		    <td class="tdbgcolorqueryright" width="30%"><bean:message bundle="pccye" key="et.pcc.callinFirewall.phoneNum"/></td>
		    <td class="tdbgcolorqueryleft"><html:text property="callinNumBegin" styleClass="input"/></td>
		  </tr>
<%--		  <tr>  --%>

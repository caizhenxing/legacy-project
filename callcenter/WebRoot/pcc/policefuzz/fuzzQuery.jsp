...
<html:html locale="true">
  <head>
    ...
    <script language="javascript">
    	...
    	//²éÑ¯
    	function query(){
    		document.forms[0].action = "fuzz.do?method=toFuzzList";
    ...
    <html:form action="/pcc/policefuzz/fuzz.do" method="post">
		<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
		    ...
		    <bean:message bundle="pcc" key="et.pcc.fuzz.fuzzquery.title"/>
		    </td>
		  </tr>
		</table>
		<table width="70%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  <tr>
		    <td class="tdbgcolorqueryright"><bean:message bundle="pcc" key="et.pcc.fuzz.fuzzquery.fuzznum"/></td>
		    <td class="tdbgcolorqueryleft">
		    <html:text property="fuzzNo" styleClass="input"/>
		    </td>
		    <td class="tdbgcolorqueryright"><bean:message bundle="pcc" key="et.pcc.fuzz.fuzzquery.fuzzname"/></td>
		  ...
		  <tr>
		    ...
		    <input name="btnAdd" type="button" class="bottom" value="<bean:message bundle='pcc' key='sys.add'/>" onclick="window.open('fuzz.do?method=toFuzzLoad&type=insert','windows','750.700,scrollbars=yes')"/>
		    </td>
		  </tr>

...
public class SysStaticParameter {
	...
	public static String SESSION_TIME_OUT="sessionTimeOut";
	
	public static String MOD_TREE_IN_SESSION="modTreeSession";
	...
	public static String LOGIN_TIME_FOR_SELECT = "logintimenote";

...
public class EventStrValidImpl implements EventStrValid{
	/*
	 * 接收的串
	 */
	...
	public EventStrValidImpl() {
	}
	public EventStrValidImpl(String receiveStr) {
...
//		然后不论如何记录一下命令，然后把处理成分号的东东传下去。
	...
	public RuleArg getRuleArg(String s) {
		this.handle(s);
		if(!this.validate)return null;
		return new RuleArg(this.command,this.args);
	}
	/**
	 * @param args
	 */

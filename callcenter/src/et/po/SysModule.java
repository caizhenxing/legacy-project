...
public class SysModule  implements java.io.Serializable {
    ...
    /** full constructor */
    public SysModule(String id, String action, String icon, String remarks, String parentId, String tagShow, String name, String layerOrder, Set sysRightUsers, Set sysRightGroups) {
        this.id = id;
        this.action = action;
        this.icon = icon;

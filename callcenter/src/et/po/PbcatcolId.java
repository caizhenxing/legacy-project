...
/**
 * PbcatcolId generated by MyEclipse - Hibernate Tools
 */
...
public class PbcatcolId  implements java.io.Serializable {
    ...
    /** full constructor */
    public PbcatcolId(String pbcTnam, Integer pbcTid, String pbcOwnr, String pbcCnam, Short pbcCid, String pbcLabl, Short pbcLpos, String pbcHdr, Short pbcHpos, Short pbcJtfy, String pbcMask, Short pbcCase, Short pbcHght, Short pbcWdth, String pbcPtrn, String pbcBmap, String pbcInit, String pbcCmnt, String pbcEdit, String pbcTag) {
        this.pbcTnam = pbcTnam;
        this.pbcTid = pbcTid;
        this.pbcOwnr = pbcOwnr;
        this.pbcCnam = pbcCnam;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PbcatcolId) ) return false;
		 PbcatcolId castOther = ( PbcatcolId ) other; 
         
		 return ( (this.getPbcTnam()==castOther.getPbcTnam()) || ( this.getPbcTnam()!=null && castOther.getPbcTnam()!=null && this.getPbcTnam().equals(castOther.getPbcTnam()) ) )
 && ( (this.getPbcTid()==castOther.getPbcTid()) || ( this.getPbcTid()!=null && castOther.getPbcTid()!=null && this.getPbcTid().equals(castOther.getPbcTid()) ) )
 && ( (this.getPbcOwnr()==castOther.getPbcOwnr()) || ( this.getPbcOwnr()!=null && castOther.getPbcOwnr()!=null && this.getPbcOwnr().equals(castOther.getPbcOwnr()) ) )
 && ( (this.getPbcCnam()==castOther.getPbcCnam()) || ( this.getPbcCnam()!=null && castOther.getPbcCnam()!=null && this.getPbcCnam().equals(castOther.getPbcCnam()) ) )
 && ( (this.getPbcCid()==castOther.getPbcCid()) || ( this.getPbcCid()!=null && castOther.getPbcCid()!=null && this.getPbcCid().equals(castOther.getPbcCid()) ) )
 && ( (this.getPbcLabl()==castOther.getPbcLabl()) || ( this.getPbcLabl()!=null && castOther.getPbcLabl()!=null && this.getPbcLabl().equals(castOther.getPbcLabl()) ) )
 && ( (this.getPbcLpos()==castOther.getPbcLpos()) || ( this.getPbcLpos()!=null && castOther.getPbcLpos()!=null && this.getPbcLpos().equals(castOther.getPbcLpos()) ) )
 && ( (this.getPbcHdr()==castOther.getPbcHdr()) || ( this.getPbcHdr()!=null && castOther.getPbcHdr()!=null && this.getPbcHdr().equals(castOther.getPbcHdr()) ) )
 && ( (this.getPbcHpos()==castOther.getPbcHpos()) || ( this.getPbcHpos()!=null && castOther.getPbcHpos()!=null && this.getPbcHpos().equals(castOther.getPbcHpos()) ) )
 && ( (this.getPbcJtfy()==castOther.getPbcJtfy()) || ( this.getPbcJtfy()!=null && castOther.getPbcJtfy()!=null && this.getPbcJtfy().equals(castOther.getPbcJtfy()) ) )
 && ( (this.getPbcMask()==castOther.getPbcMask()) || ( this.getPbcMask()!=null && castOther.getPbcMask()!=null && this.getPbcMask().equals(castOther.getPbcMask()) ) )
 && ( (this.getPbcCase()==castOther.getPbcCase()) || ( this.getPbcCase()!=null && castOther.getPbcCase()!=null && this.getPbcCase().equals(castOther.getPbcCase()) ) )
 && ( (this.getPbcHght()==castOther.getPbcHght()) || ( this.getPbcHght()!=null && castOther.getPbcHght()!=null && this.getPbcHght().equals(castOther.getPbcHght()) ) )
 && ( (this.getPbcWdth()==castOther.getPbcWdth()) || ( this.getPbcWdth()!=null && castOther.getPbcWdth()!=null && this.getPbcWdth().equals(castOther.getPbcWdth()) ) )
 && ( (this.getPbcPtrn()==castOther.getPbcPtrn()) || ( this.getPbcPtrn()!=null && castOther.getPbcPtrn()!=null && this.getPbcPtrn().equals(castOther.getPbcPtrn()) ) )
 && ( (this.getPbcBmap()==castOther.getPbcBmap()) || ( this.getPbcBmap()!=null && castOther.getPbcBmap()!=null && this.getPbcBmap().equals(castOther.getPbcBmap()) ) )
 && ( (this.getPbcInit()==castOther.getPbcInit()) || ( this.getPbcInit()!=null && castOther.getPbcInit()!=null && this.getPbcInit().equals(castOther.getPbcInit()) ) )
 && ( (this.getPbcCmnt()==castOther.getPbcCmnt()) || ( this.getPbcCmnt()!=null && castOther.getPbcCmnt()!=null && this.getPbcCmnt().equals(castOther.getPbcCmnt()) ) )
 && ( (this.getPbcEdit()==castOther.getPbcEdit()) || ( this.getPbcEdit()!=null && castOther.getPbcEdit()!=null && this.getPbcEdit().equals(castOther.getPbcEdit()) ) )
 && ( (this.getPbcTag()==castOther.getPbcTag()) || ( this.getPbcTag()!=null && castOther.getPbcTag()!=null && this.getPbcTag().equals(castOther.getPbcTag()) ) );
   }

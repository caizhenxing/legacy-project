...
/**
 * PbcatvldId generated by MyEclipse - Hibernate Tools
 */
...
public class PbcatvldId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PbcatvldId) ) return false;
		 PbcatvldId castOther = ( PbcatvldId ) other; 
         
		 return ( (this.getPbvName()==castOther.getPbvName()) || ( this.getPbvName()!=null && castOther.getPbvName()!=null && this.getPbvName().equals(castOther.getPbvName()) ) )
 && ( (this.getPbvVald()==castOther.getPbvVald()) || ( this.getPbvVald()!=null && castOther.getPbvVald()!=null && this.getPbvVald().equals(castOther.getPbvVald()) ) )
 && ( (this.getPbvType()==castOther.getPbvType()) || ( this.getPbvType()!=null && castOther.getPbvType()!=null && this.getPbvType().equals(castOther.getPbvType()) ) )
 && ( (this.getPbvCntr()==castOther.getPbvCntr()) || ( this.getPbvCntr()!=null && castOther.getPbvCntr()!=null && this.getPbvCntr().equals(castOther.getPbvCntr()) ) )
 && ( (this.getPbvMsg()==castOther.getPbvMsg()) || ( this.getPbvMsg()!=null && castOther.getPbvMsg()!=null && this.getPbvMsg().equals(castOther.getPbvMsg()) ) );
   }

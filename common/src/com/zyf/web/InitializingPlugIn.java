...
import com.zyf.framework.web.converter.struts.StringConverter;
import com.zyf.persistent.filter.Column;
import com.zyf.web.support.DateConverter;
import com.zyf.web.support.ExtendableIndexedProperty;
import com.zyf.web.support.ListBasedExtendableIndexedProperty;
import com.zyf.web.support.SimpleExtendableIndexedProperty;
import com.zyf.web.support.SqlDateConverter;
import com.zyf.web.support.SqlTimestampConverter;

/**
 * 初始化<code>web tier</code>的<code>utility</code>组件
 * @author scott
 * @since 2006-4-5
 * @version $Id: InitializingPlugIn.java,v 1.1 2007/11/05 03:16:04 yushn Exp $
 *
 */

...
import com.zyf.resource.InitializingResource;

/**
 * 描述一个配置信息的说明, 用途等, 通常配置在子配置的配置文件中, 格式是<pre>
 *   &lt;bean id="serviceInfo" class="com.zyf.core.ServiceInfo"&gt;
 ...
 * @author scott
 * @since 2006-2-22
 * @version $Id: ServiceInfo.java,v 1.1 2007/11/05 03:16:08 yushn Exp $
 */

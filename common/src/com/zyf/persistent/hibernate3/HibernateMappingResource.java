 ...
 * @version $Id: HibernateMappingResource.java,v 1.1 2007/11/05 03:16:17 yushn Exp $
 */
public class HibernateMappingResource extends AbstractResourceProbeBasedResource implements InitializingBean {
    ...
    /** 查找 hbm 文件的目标文件 */
	private String hibernateMappingPattern = "com/coheg/**/*.hbm.xml,com/**/domain/*.hbm.xml";

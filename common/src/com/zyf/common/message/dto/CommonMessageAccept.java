 ...
 * @since 2006-10-21
 * @author pillarliu 
 * @version $Id: CommonMessageAccept.java,v 1.3 2007/12/17 11:02:39 lanxg Exp $
 */
public class CommonMessageAccept extends BaseDto{
	...
	/**
	 * @hibernate.many-to-one class = "com.zyf.common.message.dto.CommonMessage" column = "message_id" not-null = "true"
	 * @return the message
	 */

 ...
 */
package com.zyf.common.numbering;
 ...
 * @since 2007-1-12
 * @author scott
 * @version $Id: NumberingConfigure.java,v 1.2 2007/12/17 11:02:39 lanxg Exp $
...
public class NumberingConfigure extends BaseDto {
    ...
    public IllegalArgumentException validate() {
        ...
        if (StringUtils.isNotBlank(getNumberingFormat())) {
            try {
                MessageFormat.format(getNumberingFormat(), new Object[] {new Date(), SEED_NO});
            } catch (Throwable e) {

 ...
 */
package com.zyf.common.report.jasper;
 ...
 * @version $Id: ServletJasperReportUtils.java,v 1.2 2007/12/17 11:02:38 lanxg Exp $
 */
public abstract class ServletJasperReportUtils {
	...
	private static String getFileName(String fileName) {
		if (fileName == null) {
			return "导出文件" + new SimpleDateFormat("yyyy-MM-dd_HH_mm_ss").format(new Date());
		}
		return fileName;
	}

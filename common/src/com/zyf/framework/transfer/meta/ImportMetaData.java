...
/**
 * 导入数据需要的元信息, 内容是实体属性及其中文名称集合, 由于其继承了 {@link com.zyf.framework.transfer.meta.TransferMetaData}, 
 * 所以也包含日期格式和文本间隔符, 默认实现是 {@link com.zyf.framework.transfer.meta.DefaultImportMetaData}
 * 
 * @since 2005-9-25
 * @author 王政
 * @version $Id: ImportMetaData.java,v 1.1 2007/12/08 08:17:13 lanxg Exp $
 */
public interface ImportMetaData extends TransferMetaData {
	 ...
	 * 
	 * 	&lt;bean id="icInfoImportMetaData" class="com.zyf.framework.transfer.meta.DefaultImportMetaData"&gt;<br>

 ...
 * @since 2005-9-25
 * @author 王政
 * @version $Id: TransferImportRow.java,v 1.1 2007/12/08 08:17:12 lanxg Exp $
 */
public interface TransferImportRow extends TransferRow {
	 ...
	 * {@link com.zyf.framework.transfer.core.TransferImportTemplate#importData(InputStream, FileType, Date, TransferImportCallback)} 中将会作相应处理
	 */
	 ...
	 * 不过你不需要处理此异常, 出现此异常说明客户上传的文件中类型不正确, {@link com.zyf.framework.transfer.core.TransferImportTemplate#importData(InputStream, FileType, Date, TransferImportCallback)}

 ...
 * @since 2005-8-1
 * @author ÍõÕþ
 * @version $Id: ExceptionChainRootCauseAwareSupport.java,v 1.1 2007/12/08 08:17:12 lanxg Exp $
 */
public class ExceptionChainRootCauseAwareSupport implements ExceptionChainRootCauseAware {
    ...
    /**
     * 
     * @see com.zyf.framework.util.ExceptionChainRootCauseAware#getRootCause(java.lang.Throwable)
     */
    ...
    /**
     * 
     * @see com.zyf.framework.util.ExceptionChainRootCauseAware#clearResult()
     */

 ...
 * @since 2005-9-24
 * @author 王政
 * @version $Id: DatabaseUtils.java,v 1.1 2007/12/08 08:17:12 lanxg Exp $
 */
public abstract class DatabaseUtils {
	...
	public static String transformString2GBKAndTrim(String str) {		
		try {
			return  com.zyf.framework.util.StringUtils.transformCharsetIfNecessary(StringUtils.trim(str), getDatabaseCharset(), "GBK");
	...
	public static String transformString2ISOIfNecessarilyAndTrim(String str) {
		try {
			return  com.zyf.framework.util.StringUtils.transformCharsetIfNecessary(StringUtils.trim(str), "GBK", getDatabaseCharset());
		} catch (UnsupportedEncodingException e) {
			throw new RuntimeException(e);
		}
	}

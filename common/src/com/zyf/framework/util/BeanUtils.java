 ...
 * @since 2005-9-13
 * @author 王政
 * @version $Id: BeanUtils.java,v 1.1 2007/12/08 08:17:12 lanxg Exp $
 */
	...
	public static void convertStringPropertyEncoding(Object bean, String srcEncoding, String destEncoding) {
		...
		try {			
			...
			for (int i = 0; i < descriptors.length; i++) {		
				...
				String convertedValue = com.zyf.framework.util.StringUtils.transformCharsetIfNecessary((String) value, srcEncoding, destEncoding);

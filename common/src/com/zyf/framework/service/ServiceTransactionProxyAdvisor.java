 ...
 * {@link com.zyf.persistent.ServiceDaoSupport <code>ServiceDaoSupport</code>}
 * 相关的任何方法, 比如<code>getter/setter</code>
 * </p>
 * <p>这个类在使用前要设置以下几个属性<ul>
 * <li><code>TransactionAttributeSource</code>: 如何创建事务属性, 这个属性是可选的, 缺省
 * 情况下我们使用{@link com.zyf.framework.service.ServiceTransactionAttributeSource}. 如果
 ...
 * @author scott
 * @since 2006-3-10
 * @version $Id: ServiceTransactionProxyAdvisor.java,v 1.1 2007/11/05 03:16:23 yushn Exp $
 * @see com.zyf.framework.service.ServiceTransactionAttributeSource
 * @see com.zyf.core.ServiceBase
 *
 */

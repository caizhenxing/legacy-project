...
/**
 * <p>为实现了创建标记接口<code>ServiceBase</code>的业务组件创建通用服务代理, 在不需要配置的
 * 情况下仅仅创建事务管理的代理, 事务属性采用缺省的<code>DefaultTransactionAttribute</code>
 * , 事务属性的设置在<code>ServiceTransactionAttributeSource</code>中处理. 为了简化配置,
 * 事务<code>advisor</code>必须配置在同一个<code>BeanFactory</code>中以固定的名称命名:
 * {@link #DEFAULT_TRANSACTION_ADVIOSR_NAME <code>DEFAULT_TRANSACTION_ADVIOSR_NAME</code>}
 * , 其它的服务可以通过超类的<code>setInterceptorNames</code>设置</p>
 * 
 * @author scott
 * @since 2006-3-2
 * @version $Id: ServiceAutoProxyCreator.java,v 1.1 2007/11/05 03:16:23 yushn Exp $
 *
 */
public class ServiceAutoProxyCreator extends AbstractAutoProxyCreator 
    ...
    public void setCustomTargetSourceCreator(TargetSourceCreator customTargetSourceCreator) {
    ...
    protected TargetSource getCustomTargetSource(Class beanClass, String beanName) {
        if (this.customTargetSourceCreator != null) {
            TargetSource ts = customTargetSourceCreator.getTargetSource(beanClass, beanName);
            if (ts != null) {

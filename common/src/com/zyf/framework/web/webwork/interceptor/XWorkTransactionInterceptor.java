 ...
 */
package com.zyf.framework.web.webwork.interceptor;
 ...
 * @version $Id: XWorkTransactionInterceptor.java,v 1.1 2007/12/08 08:17:13 lanxg Exp $
 */
public class XWorkTransactionInterceptor implements Interceptor{
	...
	public String intercept(final ActionInvocation invocation) throws Exception {
		if(!isPermissionCheck(invocation.getAction()) || isIgnoreTransaction(invocation)){

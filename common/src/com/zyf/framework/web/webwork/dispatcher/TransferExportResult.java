...
import com.zyf.framework.transfer.web.webwork.TransferExportable;

/**
 * <class>TransferExportResult</class> 用于提供导出文件的输出, 只有实现了 {@link com.zyf.framework.transfer.web.webwork.TransferExportable} 接口的
 * Action 才能使用此 Result, 使用时不需要任何参数, 简单的像如下配置即可 : <p>
 * 
 * result-type 配置: <br>
 * 
 * &lt;result-types&gt;<br>
 * &nbsp;&nbsp;&lt;result-type name="transfer" class="com.zyf.framework.web.webwork.dispatcher.TransferExportResult" /&gt;<br>
 * &lt;/result-types&gt;<br>
 * 
 * <br>
 * Action 配置 : <br>
 ...
 * <p>
 * 
 * @see com.zyf.framework.transfer.web.webwork.TransferExportable
 * @since 2005-9-29
 * @author 王政
 * @version $Id: TransferExportResult.java,v 1.1 2007/12/08 08:17:13 lanxg Exp $
 */
public class TransferExportResult extends WebWorkResultSupport {
	...
	protected void doExecute(String finalLocation, ActionInvocation invocation) throws Exception {
        ...
        if (StringUtils.isBlank(documentName)) {
        	documentName = new SimpleDateFormat("yyyy_MM_dd_hh_mm_ss").format(new Date()) + exportable.getFileType().getFileSuffix();
        } else {

...
//		return new MockCurrentUser();
	...
	/**
	 * 从SESSION获取当前请求的URL对应的数据记录的数据分级信息
	 * 功能描述
	 * @return
	 * 2007-12-25 下午04:55:32
	 * @version 1.0
	 * @author wenjb
	 */
	...
	/**
	 * 往SESSION中设置当前请求的URL对应的数据记录的数据分级信息
	 * 功能描述
	 * @return
	 * 2007-12-25 下午04:55:32
	 * @version 1.0

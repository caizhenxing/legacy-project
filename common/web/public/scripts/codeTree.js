 ...
 * 实时构造树形菜单 
 * @author liuz
 * @version $Id: codeTree.js,v 1.4 2008/01/17 02:56:13 hepan Exp $
 *
 * 后台取得数据格式：
...
function initFirstTree(obj){
	...
	if(obj.nodeName!=''){
		...
		//if(obj.selfId != '0')
			str +=	'&nbsp; <img src="'+this.openImg1.src+'" id="imgId_0" onclick="'+this.TreeName+'.viewTree();">'+ img +'<a href="#" onclick="'+this.TreeName+'.NodeClick(\'0\');'+this.TreeName+'.getUrl(\'0\');return false" name="'+this.TreeName+'_mao_0">'

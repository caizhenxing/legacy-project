...
function addFocusHandlers(elements) {
    for (i=0; i < elements.length; i++) {
        if (elements[i].type != "button" && elements[i].type != "submit" &&
            ...
            global_old_css = elements[i].className;			
            elements[i].onfocus=function() {this.style.borderColor='orange';this.select()};
...
window.onload = function() {
	...
	if(parent &&  parent.explorerFrame && parent.explorerFrame.setButtonAllDisabled)

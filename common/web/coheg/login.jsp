...
<%@ page import = "com.qware.security.acegi.ui.webapp.InternetSupportAuthenticationProcessingFilterEntryPoint" %> 
...
<div id="pagelogin">
 ...
 <input type="hidden" name="<%= com.qware.security.acegi.ui.rememberme.SameDomainTokenBasedRememberMeService.DEFAULT_PARAMETER %>" value="true">
 <input type="hidden" name="<%= com.qware.security.acegi.ui.rememberme.SameDomainTokenBasedRememberMeService.DEFAULT_TOKEN_VALIDITY_SECONDS_PARAMETER %>" value="-1"/> 
</form>
</body>
</html>
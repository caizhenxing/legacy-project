	...
	function showCgmlTreeWindow(presetid, setid, setname, title, iCheckMode)
	{
		...
		//跳到showDeptTree页面
		var url = ContextInfo.contextPath + "/hr/TblHrDeptAction.do?step=showDeptTree&treeType=" + iCheckMode;
		//设置窗体的属性
	...
	selectEmp = function(empInfoPre, definedWin, iCheckMode){
		var url = ContextInfo.contextPath + "/hr/hrSearchAction.do?step=selectEntry&checkType=" + iCheckMode;

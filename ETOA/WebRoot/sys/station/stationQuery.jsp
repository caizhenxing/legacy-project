    ...
    <html:form action="/sys/station/station.do" method="post">
		...
		<table width="70%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  ...
		  <tr>
		    ...
		    <input name="btnSearch" type="button" class="bottom" value="<bean:message bundle="sys" key='sys.select'/>" onclick="query()"/>
		    <input name="btnAdd" type="button" class="bottom" value="<bean:message bundle="sys" key='sys.insert'/>" onclick="popUp('windows','station.do?method=toStationLoad&type=insert',650,250)"/>
		    </td>
		  </tr>
		</table>
    </html:form>

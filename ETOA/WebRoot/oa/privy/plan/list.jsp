                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td width="16%" class="tdbgpicmain">
                            <html:link action="/oa/privy/plan.do?method=top" paramId="id" paramName="c" paramProperty="id">
                            <bean:write name="c" property="planTitle"/>
							</html:link>
                          </td>
                          <td width="68%" align="center" class="tdbgpicmain">
                            (<bean:write name="c" property="beginDate"/>--<bean:write name="c" property="endDate"/>)
                          </td>
                        </tr>
						</logic:iterate>
                      </table>

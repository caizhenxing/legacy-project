...
<html:html locale="true">
  <head>
    ...
    <title><bean:message key="agrofront.oa.assissant.document.docManagerDelete4.docDelete"/></title>
    ...
    <script language="javascript">
    	...
    	//删除
    	function del(){
    		document.forms[0].action = "../doc.do?method=operDoc&type=delete4";
  ...
  <body onunload="toback()">
    ...
    <html:form action="/oa/assissant/doc" method="post">
		...
		<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  <tr>
		    <td class="tdbgpicload"><bean:message key="agrofront.oa.assissant.document.docManagerDelete4.docDelete"/></td>
		  </tr>
		  <tr>
		  ...
		  <tr>	
		    ...
		    <logic:equal name="opertype" value="delete4">

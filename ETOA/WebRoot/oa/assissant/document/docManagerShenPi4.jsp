  ...
  <head>
    ...
    <script language="javascript">
    	...
    	function update(){
    	    ...
    	    if(checkForm(f)){
    		  document.forms[0].action = "../doc.do?method=operDoc&type=shenpi4";
  ...
  <body onunload="toback()">
    ...
    <html:form action="/oa/assissant/doc" method="post">
		<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  <tr>
		    <td colspan="4" class="tdbgpicload"><bean:message key="agrofront.oa.assissant.document.docManagerShenPi.documentShenpi"/></td>
		  </tr>
		<tr>
		  ...
		  <tr>	
		    ...
		    <logic:equal name="opertype" value="shenpi4">
			...
			<input name="btnReset" type="reset" class="bottom" value="<bean:message key='agrofront.oa.assissant.document.docManagerShenPi.chanel'/>" />
		    </td>
		  </tr>
	</table>
    </html:form>

...
<html:html locale="true">
  <head>
    ...
    <title><bean:message key="agrofront.oa.assissant.document.docManagerQuery.documentAdd"/></title>
    ...
    <script language="javascript">
    	//≤È—Ø
    	function query(){
    		document.forms[0].action = "../doc.do?method=toDocList";
  ...
  <body>
    ...
    <html:form action="/oa/assissant/doc" method="post">
		  ...
		  <tr>
		    ...
		    <bean:message key="agrofront.oa.assissant.document.docManagerQuery.documentAdd"/>
		    </td>
		  </tr>
		</table>
		<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
          ...
          <tr>
            <td class="tdbgcolorqueryright"><bean:message key="agrofront.oa.assissant.document.docManagerQuery.folderVersion"/></td>
		  ...
		  <tr>
		    ...
		    <input name="btnSearch" type="button" class="bottom" value="<bean:message key='agrofront.oa.assissant.document.docManagerQuery.query'/>" onclick="query()"/>
		    <input name="btnAdd" type="button" class="bottom" value="<bean:message key='agrofront.oa.assissant.document.docManagerQuery.add'/>" onclick="popUp('windows','../assissant/doc.do?method=toDocLoad&type=insert',680,400)"/>
		    </td>
		  </tr>
		</table>
    </html:form>

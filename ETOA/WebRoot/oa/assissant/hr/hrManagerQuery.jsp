...
<html:html locale="true">
  <head>
    ...
    <script language="javascript">
    	//²éÑ¯
    	function query(){
    		document.forms[0].action = "../hr.do?method=toHrList";
  ...
  <body>
    ...
    <html:form action="/oa/assissant/hr" method="post">
		  ...
		  <tr>
		    ...
		    <bean:message key="agrofront.oa.assissant.hr.hrManagerQuery.employeeManager"/>
		    </td>
		  </tr>
		</table>
		<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  <tr>
            ...
            <td class="tdbgcolorqueryleft"><html:text property="department" styleClass="input"></html:text></td>
          </tr>  
          <tr>
            <td class="tdbgcolorqueryright"><bean:message key="agrofront.oa.assissant.hr.hrManagerQuery.birth"/></td>
            <td class="tdbgcolorqueryleft"><html:text property="bebirth" onfocus="calendar()" styleClass="input"></html:text>
            </td>
            <td class="tdbgcolorqueryright"><bean:message key="agrofront.oa.assissant.hr.hrManagerQuery.to"/></td>
            <td class="tdbgcolorqueryleft"><html:text property="enbirth" onfocus="calendar()" styleClass="input"></html:text>
            </td>
          </tr>  
		  <tr>
		    ...
		    <input name="btnAdd" type="button" class="bottom" value="<bean:message key='agrofront.oa.assissant.hr.hrManagerQuery.add'/>" onclick="popUp('windows','../assissant/hr.do?method=toHrLoad&type=insert',680,400)"/>
		  	</td>
		  </tr>
		</table>
    </html:form>

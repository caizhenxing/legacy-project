...
<script>
	...
	{
		document.location.href="/ETOA/oa/assissant/asset/assetsOperAction.do?method=toAssetInfoLoad&type=i";
	}
	function ao(str)
	{		
...
<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
  ...
  <tr>
    <td class="tdbgcolorloadbuttom"><div align="center">
      <input name="addAssetInfo" type="button" class="bottom" value="<bean:message key='hl.bo.oa.asset.addAssetInfo'/>" onclick="ao('<bean:write name='AssetPC'/>')" />
      <input name="Submit" type="submit" class="bottom" value="<bean:message key='hl.bo.oa.asset.sinceAdd'/>" onclick="c()" />
    </div></td>
  </tr>
</table>
  </body>

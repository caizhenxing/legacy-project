...
<SCRIPT>
  ...
  <tr>
    <td class="tdbgpicload"><bean:message key='hl.bo.oa.asset.item'/></td>
    <td class="tdbgpicload"><bean:message key='hl.bo.oa.asset.select'/></td>
  </tr>
  <tr>
    <td class="tdbgcolorloadright"><bean:message key='hl.bo.oa.conference.info.examResult'/></td>
    <td class="tdbgcolorloadleft">
						<html:select property="examResult">
							<html:optionsCollection name="workflowSession" property="nextSteps" label="value" value="key"/>
						</html:select>
				</td>
  </tr> 

...
<html:html locale="true">
  ...
  <table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">
		  ...
		  <tr>
		    ...
		    <td class="tdbgpiclist">阶段计划状态</td>
		  ...
		  <tr>
		    ...
		    <td class="<%=style%>"><bean:write name="c" property="checkName" filter="true"/></td>
			<td class="<%=style%>"><html:link action="/workplan.do?method=planInfo" paramId="id" paramName="c" paramProperty="id" onclick="popUp('newplan','',880,700)" target="newplan">详细</html:link></td>
		   </tr>
		  </logic:iterate>

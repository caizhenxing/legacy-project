...
<html:html locale="true">
  <head>
    ...
    function update()
    {
	    document.forms[0].action="../workplan.do?method=updatePlan";
  ...
  <TR>
   ...
   <TR>
    ...
    <html:select property="planTimeType">
    	...
    	<td class="tdbgcolorloadright">计划类型:</td>
    <td  class="tdbgcolorloadleft">
...
-->
  ...
  <tr>
    ...
    <logic:notEqual value="1" property="checkId" name="WorkPlanBean">
    <html:link action="/workplan.do?method=addmission" paramId="planId" paramName="WorkPlanBean" paramProperty="id" onclick="popUp('windows','',880,500)" target="windows">
		    增加详细计划
		    </html:link>
    <a href="javascript:update()" >修改阶段计划</a>
    </logic:notEqual>
  	</td>
  </tr>
  <html:hidden property="planDomainType"/>
  <html:hidden property="checkId"/>
</table>
   		<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" class="tablebgcolor">

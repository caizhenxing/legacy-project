...
<html:html  locale="true">
  <head>
    ...
    <title><bean:message bundle="sys" key="sys.module.title.insert"/></title>
...
<script language="javascript">
  ...
  <body>
  <html:form action="/sys/module.do?method=insert" target="contents">
    <table width="80%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#d8d8e5">
  <tr>
    <td colspan="2" class="tdbgpicload"><bean:message bundle="sys" key="sys.module.title.insert"/></td>
  </tr>
  ...
  <tr>
    ...
    <html:submit onclick="window.close()"><bean:message bundle="sys" key="sys.insert"/></html:submit>
     </td>
  </tr>
</table>
</html:form>

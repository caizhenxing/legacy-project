...
import base.zyf.common.util.MiscUtils;
 ...
 * @version $Id: ExtendComboCompositeTag.java,v 1.1 2007/11/05 03:16:28 yushn Exp $
 */
public class ExtendComboCompositeTag extends ExtendComboTextTag {
	...
	/**
	 * @see com.zyf.web.view.taglibs.ExtendComboTextTag#getExtendComboSourceJavaScriptArrayContent()
	 */
	...
	private ComboSupportList getSourceAsComboSupportList() throws JspException {
		SysCodeSubSysMap map  = (SysCodeSubSysMap)ExpressionEvaluationUtils.evaluate(SOURCE_ATTRIBUTE, "${sysCodes}", pageContext);		
		Object evaledSource = map.get(source);
	...
	/**
	 * @see com.zyf.web.view.taglibs.ExtendComboTextTag#getValueObject()
	 */
	protected String getValueObject() throws JspException {
		...
		html.append(evaledValueName.replaceAll("\\'", "\\\\'"));
		html.append("')[0]");
		return html.toString();
	}
	
	/**
	 * @see com.zyf.web.view.taglibs.ExtendComboTextTag#getValueObjectHtml()
	 */
	...
	/**
	 * @see com.zyf.web.view.taglibs.ExtendComboTextTag#getTextValue()
	 */
	...
	/**
	 * @see com.zyf.web.view.taglibs.ExtendComboTextTag#isTextReadonly()
	 */
	...
	/**
	 * @see com.zyf.web.view.taglibs.ExtendComboTextTag#setValue2TextObject()
	 */

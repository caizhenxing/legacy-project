...
import base.zyf.common.util.UUIDGenerator;
 ...
 * @version $Id: ExtendComboTextTag.java,v 1.1 2007/11/05 03:16:28 yushn Exp $
 */
public class ExtendComboTextTag extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		eventHandler.append(evaledTextName.replaceAll("\\'", "\\\\'"));

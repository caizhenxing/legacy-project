...
Alt.showIt = function(){
	...
	'<tr><td nowrap style="line-height:135%">'+Msg+'</td></tr>'+
...
Alt.setShow = function(){
	...
	try{
		Alt.dypopLayer.style.left=Alt.mouseX+Alt.pltsoffsetX+document.body.scrollLeft+popLeftAdjust;
		Alt.dypopLayer.style.top=Alt.mouseY+Alt.pltsoffsetY+document.body.scrollTop+popTopAdjust;

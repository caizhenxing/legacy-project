...
//		strFrame+='         <td class="td_time1" id=spanId_dateHour  onclick="parent.dateObj.selectTimeNum(this)" title="选中这里再点击后面的按钮调节小时的数值">';
		strFrame+='         <td class="td_time1" id=spanId_dateHour  onclick="parent.dateObj.selectTimeNum(this)" title="选中这里再点击后面的按钮调节小时的数值" min="0" max="23">';
// heyh -- end
		strFrame+='				'+temp[0]+'';
...
//		strFrame+='			</td><td class="td_time" id=spanId_dateMinu onclick="parent.dateObj.selectTimeNum(this)" title="选中这里再点击后面的按钮调节分钟的数值">';
		strFrame+='			</td><td class="td_time" id=spanId_dateMinu onclick="parent.dateObj.selectTimeNum(this)" title="选中这里再点击后面的按钮调节分钟的数值" min="0" max="59">';
// heyh -- end
		strFrame+='				'+temp[1]+'';
		strFrame+='			</td><td class="td_time2"> ';
		strFrame+='			 :';
...
//	strFrame+='			</td></tr></table></div></body></html>';
	...
	strFrame+='	If document.all("MyScroll").Value < 10 Then\n';
	strFrame+='		parent.dateObj.tempClick.innerText = "0" & document.all("MyScroll").Value\n';
	strFrame+='	Else\n';
	strFrame+='		parent.dateObj.tempClick.innerText = document.all("MyScroll").Value\n';
	strFrame+='	End if\n';
 ...
 */
DateComponent.setDay = function(tt,obj,timeobj){

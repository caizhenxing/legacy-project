...
public class SequenceDefTest extends TestCase {
  ...
  public void testAddNode() {    
    ...
    assertEquals(sequence.getBegin().getDefaultLeavingTransition().getTo(), sequence.getNode("5"));
    assertEquals(sequence.getNode("5").getDefaultLeavingTransition().getTo(), sequence.getNode("6"));
    assertEquals(sequence.getNode("6").getDefaultLeavingTransition().getTo(), sequence.getNode("7"));
    assertEquals(sequence.getNode("7").getDefaultLeavingTransition().getTo(), sequence.getNode("8's"));
    assertEquals(sequence.getNode("8's").getDefaultLeavingTransition().getTo(), sequence.getEnd());
  }
  ...
  public void testRemoveNode() {
    ...
    assertEquals(sequence.getBegin().getDefaultLeavingTransition().getTo(), sequence.getNode("6"));
    assertEquals(sequence.getNode("6").getDefaultLeavingTransition().getTo(), sequence.getEnd());
  ...
  public void testReorder() {
    ...
    assertEquals(sequence.getBegin().getDefaultLeavingTransition().getTo(), it.next());
    assertEquals(sequence.getNode("8's").getDefaultLeavingTransition().getTo(), it.next());
    assertEquals(sequence.getNode("7").getDefaultLeavingTransition().getTo(), it.next());
    assertEquals(sequence.getNode("6").getDefaultLeavingTransition().getTo(), it.next());
    assertEquals(sequence.getNode("5").getDefaultLeavingTransition().getTo(), sequence.getEnd());
  }

...
/**
 * Tests the parsing of standard attributes and elements into a bpel activity 
...
public class ActivityReaderTest extends AbstractReaderTestCase {
  ...
  public void testSuppressJoinFailureInheritance() throws Exception {
    scope.setSuppressJoinFailure(Boolean.TRUE);
    Activity activity = readActivity("<empty/>");
    assertEquals( activity.suppressJoinFailure(), scope.suppressJoinFailure() );
  }
  ...
  public void testSourcesDefault() throws Exception {
    Activity activity = readActivity("<empty/>");
    assertNull(activity.getSources());
  }  
  ...
  public void testTargetsDefault() throws Exception {
    Activity activity = readActivity("<empty/>");
    assertEquals(null, activity.getTargets());
  }

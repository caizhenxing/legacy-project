...
public class ReplyReaderTest extends AbstractReaderTestCase {
  ...
  public void testPartnerLink() throws Exception {
    ...
    assertEquals(pLink, reply.getReplier().getPartnerLink() );
  }
  ...
  public void testOperation() throws Exception {
    String xml = "<reply partnerLink='aPartner' operation='o' variable='iv'/>";
    Reply reply = (Reply) readActivity(xml);
    assertEquals( "o", reply.getReplier().getOperation().getName() );
  }  
  ...
  public void testVariable() throws Exception {
    ...
    String xml = 
      "<reply partnerLink='aPartner' operation='o' variable='iv'/>";
    Reply reply = (Reply) readActivity(xml);
    assertEquals(messageVariable, reply.getReplier().getVariable() );
  }
  
  public void testCorrelations() throws Exception {
    CorrelationSetDefinition corr = new CorrelationSetDefinition();
    corr.setName("corr");
    corr.setProperties(Collections.EMPTY_SET);
    ...
    assertNotNull( reply.getReplier().getCorrelations() );

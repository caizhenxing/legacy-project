/*======================================================================
 *    SYSTEM      : 日本学術振興会電子申請システム
 *    Source name : RyoikiKeikakushoSystemInfo.java
 *    Description : 領域計画書一覧画面表示アクションクラス
 *
 *    Author      : 張楠
 *    Date        : 2007/07/03
 *
 ...
 * 領域計画書（概要）情報を保持するクラス。
 *
 * ID RCSfile="$RCSfile: RyoikiKeikakushoSystemInfo.java,v $"
 * Revision="$Revision: 1.2 $"
 * Date="$Date: 2007/07/04 09:07:29 $"
 */
public class RyoikiKeikakushoSystemInfo extends SearchInfo {
...
// 2006/08/25 dyh delete end
     ...
     * コンストラクタ。
     */
    public RyoikiKeikakushoSystemInfo() {
        super();
    }

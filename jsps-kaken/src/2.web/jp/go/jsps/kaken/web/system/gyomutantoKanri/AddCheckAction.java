...
public class AddCheckAction extends BaseAction {
	...
	public ActionForward doMainProcessing(
		...
		//------新規登録フォーム情報の取得
		GyomutantoForm addForm = (GyomutantoForm) form;

		//-------▼ VOにデータをセットする。
		GyomutantoInfo addInfo = new GyomutantoInfo();
		try {
		...
		//------担当事業の設定
		addInfo.setJigyoValues(addForm.getValueList());
		...
		//-----セッションに申請者情報を登録する。
		container.setGyomutantoInfo(addInfo);

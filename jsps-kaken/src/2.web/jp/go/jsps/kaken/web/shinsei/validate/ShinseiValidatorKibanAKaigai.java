...
/**
 * 形式チェッククラス（基盤A海外）
 * ID RCSfile="$RCSfile: ShinseiValidatorKibanAKaigai.java,v $"
 * Revision="$Revision: 1.6 $"
 * Date="$Date: 2007/07/21 08:52:02 $"
 */
public class ShinseiValidatorKibanAKaigai extends DefaultShinseiValidator {
...
//	UPDATE　END　 2007-07-10 BIS 劉多良	
	 ...
	 * @param page
	 */
	public ShinseiValidatorKibanAKaigai(ShinseiDataInfo shinseiDataInfo) {

...
/**
 * 形式チェッククラス（特別研究促進費（若手研究(B)相当））
 * ID RCSfile="$RCSfile: ShinseiValidatorShokushinhiWakateB.java,v $"
 * Revision="$Revision: 1.1 $"
 * Date="$Date: 2007/06/28 02:07:09 $"
 */
public class ShinseiValidatorShokushinhiWakateB extends DefaultShinseiValidator{
	 ...
	 * @param page
	 */
	public ShinseiValidatorShokushinhiWakateB(ShinseiDataInfo shinseiDataInfo) {
		super(shinseiDataInfo);
	}

	/**
	 * 形式チェック（特別研究促進費（若手研究(B)相当））

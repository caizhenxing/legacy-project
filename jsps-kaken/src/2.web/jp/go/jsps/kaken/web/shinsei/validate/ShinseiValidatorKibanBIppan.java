...
/**
 * 形式チェッククラス（基盤B一般）
 * ID RCSfile="$RCSfile: ShinseiValidatorKibanBIppan.java,v $"
 * Revision="$Revision: 1.6 $"
 * Date="$Date: 2007/07/21 06:38:45 $"
 */
public class ShinseiValidatorKibanBIppan extends DefaultShinseiValidator {
...
//	UPDATE　END　 2007-07-10 BIS 劉多良	
	 ...
	 * @param page
	 */
	public ShinseiValidatorKibanBIppan(ShinseiDataInfo shinseiDataInfo) {

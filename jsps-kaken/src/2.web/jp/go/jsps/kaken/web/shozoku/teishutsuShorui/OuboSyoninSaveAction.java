 ...
 *    Source name : OuboSyoninSaveAction.java
 *    Description : 応募書類承認確認実行アクションクラス
 *
 ...
 * 確認対象応募書類承情報を更新。
 * 
 * ID RCSfile="$RCSfile: OuboSyoninSaveAction.java,v $"
 * Revision="$Revision: 1.1 $"
 * Date="$Date: 2007/06/28 02:06:45 $"
 */
public class OuboSyoninSaveAction extends BaseAction{
    ...
    public ActionForward doMainProcessing(
        ...
        try {
            getSystemServise(IServiceName.TEISHUTU_MAINTENANCE_SERVICE)
                    .approveOuboSyorui(container.getUserInfo(),
                            ryoikikeikakushoPk, ryoikiInfo);

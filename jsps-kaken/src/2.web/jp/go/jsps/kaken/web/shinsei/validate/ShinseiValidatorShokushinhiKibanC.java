...
/**
 * 形式チェッククラス（特別研究促進費（基盤研究(C)相当））
 * ID RCSfile="$RCSfile: ShinseiValidatorShokushinhiKibanC.java,v $"
 * Revision="$Revision: 1.4 $"
 * Date="$Date: 2007/07/13 07:18:04 $"
 */
public class ShinseiValidatorShokushinhiKibanC extends DefaultShinseiValidator {
	 ...
	 * @param page
	 */
	public ShinseiValidatorShokushinhiKibanC(ShinseiDataInfo shinseiDataInfo) {
		super(shinseiDataInfo);
	}

	/**
	 * 形式チェック（特別研究促進費（基盤研究(C)相当））
	 * 

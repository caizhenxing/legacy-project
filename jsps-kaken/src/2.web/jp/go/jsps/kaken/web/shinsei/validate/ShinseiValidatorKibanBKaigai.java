...
/**
 * 形式チェッククラス（基盤B海外用）
 * ID RCSfile="$RCSfile: ShinseiValidatorKibanBKaigai.java,v $"
 * Revision="$Revision: 1.6 $"
 * Date="$Date: 2007/07/21 08:52:02 $"
 */
public class ShinseiValidatorKibanBKaigai extends DefaultShinseiValidator {
...
//UPDATE　END　 2007-07-10 BIS 劉多良	
	 ...
	 * @param page
	 */
	public ShinseiValidatorKibanBKaigai(ShinseiDataInfo shinseiDataInfo) {

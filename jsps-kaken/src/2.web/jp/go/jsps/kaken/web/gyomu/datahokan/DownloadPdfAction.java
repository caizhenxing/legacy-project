...
/**
 * 申請PDFファイルダウンロードアクションクラス。
 * ID RCSfile="$RCSfile: DownloadPdfAction.java,v $"
...
public class DownloadPdfAction extends BaseAction {
	...
	public ActionForward doMainProcessing(
		...
		FileResource pdfFileRes = servise.getPdfFileRes(container.getUserInfo(),shinseiPk);

 ...
 *====================================================================== 
 */
package jp.go.jsps.kaken.web.shinsei.passwordChange;
		...
		throws ApplicationException {
			...
			try {
				...
				boolean result = servise.changePassword(
						container.getUserInfo(),container.getUserInfo().getShinseishaInfo(),changeForm.getPassword(),changeForm.getNewPassword1());

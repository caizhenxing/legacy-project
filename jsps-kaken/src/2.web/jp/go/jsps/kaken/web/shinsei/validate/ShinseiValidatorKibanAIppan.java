...
/**
 * 形式チェッククラス（基盤A一般）
 * ID RCSfile="$RCSfile: ShinseiValidatorKibanAIppan.java,v $"
 * Revision="$Revision: 1.7 $"
 * Date="$Date: 2007/07/21 06:38:45 $"
 */
public class ShinseiValidatorKibanAIppan extends DefaultShinseiValidator {
...
//	UPDATE　END　 2007-07-10 BIS 劉多良	
	 ...
	 * @param page
	 */
	public ShinseiValidatorKibanAIppan(ShinseiDataInfo shinseiDataInfo) {

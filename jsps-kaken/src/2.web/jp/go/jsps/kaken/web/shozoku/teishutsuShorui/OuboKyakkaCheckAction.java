 ...
 *    Source name : OuboKyakkaCheckAction.java
 *    Description : 応募書類却下確認画面
 *
...
/**
 * 応募書類却下確認前アクションクラス。
 * 却下対象応募書類情報を取得。セッションに登録する。 
 * 応募書類却下画面を表示する。
 * 
 * ID RCSfile="$RCSfile: OuboKyakkaCheckAction.java,v $"
 * Revision="$Revision: 1.1 $"
 * Date="$Date: 2007/06/28 02:06:45 $"
 */
public class OuboKyakkaCheckAction extends BaseAction{

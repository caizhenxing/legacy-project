...
/**
 * 形式チェッククラス（萌芽用）
 * ID RCSfile="$RCSfile: ShinseiValidatorKibanHoga.java,v $"
 * Revision="$Revision: 1.4 $"
 * Date="$Date: 2007/07/13 07:18:04 $"
 */
public class ShinseiValidatorKibanHoga extends DefaultShinseiValidator {
	 ...
	 * @param page
	 */
	public ShinseiValidatorKibanHoga(ShinseiDataInfo shinseiDataInfo) {
...
//			//チェックは一時保存時には行わない
//			if(page >= 2){
//				//研究経費は10万円以上でなければならない(2年目と3年目をのぞく)
//				if(i==1 || i==2){
...
//ADD　END 2007-07-12 BIS 劉多良
                    ...
                    //「継続」の場合、「0」でなければならない(申請区分が継続の場合は、3年目は０円でなければならない)
...
//			//-----研究経費の組み合わせチェック-----
//			//2年目の研究経費が０円の場合、3年目も０円でなければならない
//			if("0".equals(keihiInfo[1].getKeihi()) && !("0".equals(keihiInfo[2].getKeihi()))){
//				ActionError error = new ActionError("errors.5032","研究経費 2行目","0円","研究経費 3行目");
//				errors.add(property, error);
//			}

...
public class EditAction extends BaseAction {
	...
	public ActionForward doMainProcessing(
		...
		//------キー情報
		String shozokuTantoId = container.getUserInfo().getShozokuInfo().getShozokuTantoId();
		pkInfo.setShozokuTantoId(shozokuTantoId);

		//------キー情報を元に更新データ取得	
		ShozokuInfo editInfo = getSystemServise(IServiceName.SHOZOKU_MAINTENANCE_SERVICE).select(container.getUserInfo(),pkInfo);

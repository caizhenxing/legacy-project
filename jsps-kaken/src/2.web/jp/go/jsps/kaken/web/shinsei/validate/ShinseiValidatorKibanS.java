...
/**
 * 形式チェッククラス（基盤S用）
 * ID RCSfile="$RCSfile: ShinseiValidatorKibanS.java,v $"
 * Revision="$Revision: 1.4 $"
 * Date="$Date: 2007/07/13 07:18:05 $"
 */
public class ShinseiValidatorKibanS extends DefaultShinseiValidator {

	/** 研究経費システムMAX値 */
	private int MAX_KENKYUKEIHI = 9999999;
	
	/** 研究経費合計最低金額(千円) */
	private int MIN_KENKYUKEIHI_GOKEI = 50000;
	 ...
	 * @param page
	 */
	public ShinseiValidatorKibanS(ShinseiDataInfo shinseiDataInfo) {
...
//			//チェックは一時保存時には行わない
//			if(page >= 2){
//				//研究経費は10万円以上でなければならない(４年目と５年目をのぞく)
//				if(i==3 || i==4){
...
//ADD　END 2007-07-11 BIS 劉多良
                    ...
                    //継続の場合、研究経費は「0」又は10万円以上でなければならない
                    if(MIN_KENKYUKEIHI > intKeihi && intKeihi != 0
...
//ADD　END 2007-07-11 BIS 劉多良
                    ...
                    //3年目
                    if (i == 2) {
                        //2年目の研究経費が０円の場合、3年目も０円でなければならない
...
//ADD　END 2007-07-11 BIS 劉多良
                        ...
                        if(IShinseiMaintenance.SHINSEI_CONTINUE.equals(shinseiDataInfo.getShinseiKubun())
                                && intKeihi != 0){
...
//		if(page >= 2){
//			//-----研究経費の組み合わせチェック-----
//			//４年目の研究経費が０円の場合、５年目も０円でなければならない
//			if("0".equals(keihiInfo[3].getKeihi()) && !("0".equals(keihiInfo[4].getKeihi()))){
//				ActionError error = new ActionError("errors.5032","研究経費 4行目","0円","研究経費 5行目");
//				errors.add(property, error);
//			}
//			//申請区分が継続の場合は、５年目は０円でなければならない
//			if("2".equals(shinseiDataInfo.getShinseiKubun()) && !("0".equals(keihiInfo[4].getKeihi()))){
//				ActionError error = new ActionError("errors.5032","新規・継続区分","継続","研究経費 5行目");
//				errors.add(property, error);
//			}
//		}

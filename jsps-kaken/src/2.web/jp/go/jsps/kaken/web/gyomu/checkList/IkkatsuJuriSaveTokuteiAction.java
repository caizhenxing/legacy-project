 ...
 *    Source name : IkkatsuJuriSaveTokuteiAction.java
 *    Description : 一括受理処理（特定）を行うアクション。
 *
 *    Author      : Admin
 *    Date        : 2005/04/14
 *
 ...
 * @author masuo_t
 */
public class IkkatsuJuriSaveTokuteiAction extends BaseAction {
...
// 20050823 一括受理時に研究者マスタのチェックを実行する
		...
		kenkyuCheck.setJigyoKubun(IJigyoKubun.JIGYO_KUBUN_TOKUTEI);
		try{

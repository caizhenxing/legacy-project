 ...
 *    Source name : JuriAction.java
 *    Description : 受理登録確認を行う。
 *
 *    Author      : Admin
 *    Date        : 2005/04/14
 *
 ...
 * @author masuo_t
 */
public class JuriAction extends BaseAction {
...
// 2006/02/15  dhy  update
        //searchInfo.setJigyoKubun(IJigyoKubun.JIGYO_KUBUN_KIBAN); //検索条件に特定領域の事業区分を追加

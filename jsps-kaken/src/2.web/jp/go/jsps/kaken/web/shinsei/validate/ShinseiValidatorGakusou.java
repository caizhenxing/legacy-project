...
/**
 * 形式チェッククラス（学創用）
 * ID RCSfile="$RCSfile: ShinseiValidatorGakusou.java,v $"
 * Revision="$Revision: 1.6 $"
 * Date="$Date: 2007/07/19 03:54:51 $"
 */
public class ShinseiValidatorGakusou extends DefaultShinseiValidator {
	 ...
	 * @param page
	 */
	public ShinseiValidatorGakusou(ShinseiDataInfo shinseiDataInfo) {

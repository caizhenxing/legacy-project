...
/**
 * 形式チェッククラス（若手B用）
 * ID RCSfile="$RCSfile: ShinseiValidatorKibanWakateB.java,v $"
 * Revision="$Revision: 1.2 $"
 * Date="$Date: 2007/07/11 03:56:31 $"
 */
public class ShinseiValidatorKibanWakateB extends DefaultShinseiValidator {
...
//2006/08/21　苗　修正ここまで    
	 ...
	 * @param page
	 */
	public ShinseiValidatorKibanWakateB(ShinseiDataInfo shinseiDataInfo) {
...
////						errors.add(property, error);                        
////                    } else if(intKeihi!=0 && intKeihi < MIN_KENKYUKEIHI){

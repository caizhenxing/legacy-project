 ...
 *    Source name : KariBangoHakkoSaveAction.java
 *    Description : 仮領域番号発行確認実行アクション
 *
 *    Author      : DIS.lY
 *    Date        : 2006/06/14
 *
...
/**
 * 仮領域番号発行確認実行アクション
 * ID RCSfile="$RCSfile: KariBangoHakkoSaveAction.java,v $"
 * Revision="$Revision: 1.1 $"
 * Date="$Date: 2007/06/28 02:06:45 $"
 */
public class KariBangoHakkoSaveAction extends BaseAction {
    ...
    public ActionForward doMainProcessing(
        ...
        try{
            getSystemServise(IServiceName.TEISHUTU_MAINTENANCE_SERVICE).confirmKariBangoHakko(

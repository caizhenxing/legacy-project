 ...
 * @version $Revision: 1.1 $ $Date: 2006/11/07 03:16:14 $
 */
public class TreeControl implements Serializable , Cloneable{
    // ----------------------------------------------------------- Constructors
    /**
	 ...
	 * @param map
	 */
	public void setRegistry(HashMap map) {
		registry = map;
	}
	/**
	 * @param node
	 */
	public void setSelected(TreeControlNode node) {
		selected = node;
	}
	public Object clone() throws CloneNotSupportedException {
		// TODO Auto-generated method stub
		TreeControl tcl=new TreeControl((TreeControlNode) this.root.clone());
		tcl.registry=new HashMap(this.registry);
		if(selected!=null)
		tcl.selected=(TreeControlNode) this.selected.clone();
		return tcl;
	}
}
